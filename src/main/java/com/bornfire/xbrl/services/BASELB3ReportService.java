...
import com.bornfire.xbrl.entities.BRBS.BASELB3ServiceRepo;
import com.bornfire.xbrl.entities.BRBS.BASEL_B3_1_REPORT_ENTITY;
import com.bornfire.xbrl.entities.BRBS.BASEL_B3_2_REPORT_ENTITY;
import com.bornfire.xbrl.entities.BRBS.BASEL_B3_3_REPORT_ENTITY;
import com.bornfire.xbrl.entities.BRBS.BASEL_B3_4_REPORT_ENTITY;
import com.bornfire.xbrl.entities.BRBS.BASEL_B3_5_REPORT_ENTITY;
import com.bornfire.xbrl.entities.BRBS.BASEL_B3_6_REPORT_ENTITY;
...
public class BASELB3ReportService {
	private static final Logger logger = LoggerFactory.getLogger(BASELB3ReportService.class);
	...
	@Autowired
	BASELB3ServiceRepo BASELB3ServiceRepo;
	...
	public String preCheckBASELB3(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_B3_1_REPORT_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_B3_1_REPORT_ENTITY a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBASELB3View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<BASEL_B3_1_REPORT_ENTITY> T1rep = new ArrayList<BASEL_B3_1_REPORT_ENTITY>();
		// Query<Object[]> qr;

		List<BASEL_B3_1_REPORT_ENTITY> T1Master = new ArrayList<BASEL_B3_1_REPORT_ENTITY>();
		List<BASEL_B3_2_REPORT_ENTITY> T1Master1 = new ArrayList<BASEL_B3_2_REPORT_ENTITY>();
		List<BASEL_B3_3_REPORT_ENTITY> T1Master2 = new ArrayList<BASEL_B3_3_REPORT_ENTITY>();
		List<BASEL_B3_4_REPORT_ENTITY> T1Master3 = new ArrayList<BASEL_B3_4_REPORT_ENTITY>();
		List<BASEL_B3_5_REPORT_ENTITY> T1Master4 = new ArrayList<BASEL_B3_5_REPORT_ENTITY>();
		List<BASEL_B3_6_REPORT_ENTITY> T1Master5 = new ArrayList<BASEL_B3_6_REPORT_ENTITY>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from BASEL_B3_1_REPORT_ENTITY a where a.report_date = ?1 ",BASEL_B3_1_REPORT_ENTITY.class)
					.setParameter(1, df.parse(todate)).getResultList();

			T1Master1 = hs.createQuery("from BASEL_B3_2_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_B3_2_REPORT_ENTITY.class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master2= hs.createQuery("from BASEL_B3_3_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_B3_3_REPORT_ENTITY.class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master3 = hs.createQuery("from BASEL_B3_4_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_B3_4_REPORT_ENTITY.class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master4 = hs.createQuery("from BASEL_B3_5_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_B3_5_REPORT_ENTITY.class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master5 = hs.createQuery("from BASEL_B3_6_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_B3_6_REPORT_ENTITY.class)
					.setParameter(1, df.parse(todate)).getResultList();
	...
	public ModelAndView getBASELB3Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BASELB3::reportcontent");
	...
	public File getFileBASELB3(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BASEL_B3.jrxml");
					}
