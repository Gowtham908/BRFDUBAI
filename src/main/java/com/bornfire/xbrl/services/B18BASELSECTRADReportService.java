...
import com.bornfire.xbrl.entities.BRBS.B18_BASEL_SECURITIZATION_TRADING_RPT;
...
public class B18BASELSECTRADReportService {
	private static final Logger logger = LoggerFactory.getLogger(B18BASELSECTRADReportService.class);
	...
	public String preCheckB18BASELSECTRAD(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B18_BASEL_SECURITIZATION_TRADING_RPT a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B18_BASEL_SECURITIZATION_TRADING_RPT a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB18BASELSECTRADView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B18_BASEL_SECURITIZATION_TRADING_RPT> T1rep = new ArrayList<B18_BASEL_SECURITIZATION_TRADING_RPT>();
		// Query<Object[]> qr;

		List<B18_BASEL_SECURITIZATION_TRADING_RPT> T1Master = new ArrayList<B18_BASEL_SECURITIZATION_TRADING_RPT>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B18_BASEL_SECURITIZATION_TRADING_RPT a where a.report_date = ?1 ", B18_BASEL_SECURITIZATION_TRADING_RPT.class)
		...
		mv.setViewName("RR/B18BASELSECTRAD");
	...
	public ModelAndView getB18BASELSECTRADDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B18BASELSECTRAD::reportcontent");
	...
	public File getFileB18BASELSECTRAD(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B18BASELSECTRAD.jrxml");
					}
