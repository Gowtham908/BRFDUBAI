...
import com.bornfire.xbrl.entities.BRBS.B13Reportentity;
import com.bornfire.xbrl.entities.BRBS.B13ServiceRepo;
import com.bornfire.xbrl.entities.BRBS.B13_1Reportentity;
...
public class B13ReportService  {
	private static final Logger logger = LoggerFactory.getLogger(B13ReportService .class);
	...
	public String preCheckB13(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B13Reportentity  a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B13Reportentity  a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB13View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B13Reportentity > T1rep = new ArrayList<B13Reportentity >();
		// Query<Object[]> qr;

		List<B13Reportentity > T1Master = new ArrayList<B13Reportentity >();
		
		List<B13_1Reportentity > T1Master1 = new ArrayList<B13_1Reportentity >();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B13Reportentity  a where a.report_date = ?1 ", B13Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();

			
			T1Master1 = hs.createQuery("from B13_1Reportentity  a where a.report_date = ?1 ", B13_1Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();
	...
	public File getFileB13(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B13_1.jrxml");
					}
...
*/
	...
	public ModelAndView getB13currentDtl(String reportId, String fromdate, String todate, String currency,
			...
			mv.setViewName("RR"+"/"+"B13::reportcontent");
