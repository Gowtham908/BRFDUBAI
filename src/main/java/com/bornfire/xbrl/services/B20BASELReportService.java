...
import com.bornfire.xbrl.entities.BRBS.B20_BASEL_RPT;
...
public class B20BASELReportService {
	private static final Logger logger = LoggerFactory.getLogger(B20BASELReportService.class);
	...
	public String preCheckB20BASEL(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B20_BASEL_RPT a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B20_BASEL_RPT a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB20BASELView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B20_BASEL_RPT> T1rep = new ArrayList<B20_BASEL_RPT>();
		// Query<Object[]> qr;

		List<B20_BASEL_RPT> T1Master = new ArrayList<B20_BASEL_RPT>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B20_BASEL_RPT a where a.report_date = ?1", B20_BASEL_RPT.class)
	...
	public ModelAndView getB20BASELDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B20BASEL::reportcontent");
	...
	public File getFileB20BASEL(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B20BASEL.jrxml");
					}
