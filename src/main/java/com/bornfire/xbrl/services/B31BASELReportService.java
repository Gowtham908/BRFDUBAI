...
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT1;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT10;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT2;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT3;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT4;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT5;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT6;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT7;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT8;
import com.bornfire.xbrl.entities.BRBS.B31_BASEL_RPT9;
...
public class B31BASELReportService {
	private static final Logger logger = LoggerFactory.getLogger(B31BASELReportService.class);
	...
	public String preCheckB31BASEL(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B31_BASEL_RPT a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B31_BASEL_RPT a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB31BASELView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B31_BASEL_RPT> T1rep = new ArrayList<B31_BASEL_RPT>();
		// Query<Object[]> qr;

		List<B31_BASEL_RPT> T1Master = new ArrayList<B31_BASEL_RPT>();
		List<B31_BASEL_RPT1> T1Master1 = new ArrayList<B31_BASEL_RPT1>();
		List<B31_BASEL_RPT2> T1Master2 = new ArrayList<B31_BASEL_RPT2>();
		List<B31_BASEL_RPT3> T1Master3 = new ArrayList<B31_BASEL_RPT3>();
		List<B31_BASEL_RPT4> T1Master4 = new ArrayList<B31_BASEL_RPT4>();
		List<B31_BASEL_RPT5> T1Master5 = new ArrayList<B31_BASEL_RPT5>();
		List<B31_BASEL_RPT6> T1Master6 = new ArrayList<B31_BASEL_RPT6>();
		List<B31_BASEL_RPT7> T1Master7 = new ArrayList<B31_BASEL_RPT7>();
		List<B31_BASEL_RPT8> T1Master8 = new ArrayList<B31_BASEL_RPT8>();
		List<B31_BASEL_RPT9> T1Master9 = new ArrayList<B31_BASEL_RPT9>();
		List<B31_BASEL_RPT10> T1Master10 = new ArrayList<B31_BASEL_RPT10>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B31_BASEL_RPT a where a.report_date = ?1", B31_BASEL_RPT.class)
					.setParameter(1, df.parse(todate)).getResultList();
			

			T1Master1 = hs.createQuery("from B31_BASEL_RPT1 a where a.report_date = ?1 ", B31_BASEL_RPT1.class)
					.setParameter(1, df.parse(todate)).getResultList();

			T1Master2 = hs.createQuery("from B31_BASEL_RPT2 a where a.report_date = ?1 ", B31_BASEL_RPT2.class)
					.setParameter(1, df.parse(todate)).getResultList();
			T1Master3 = hs.createQuery("from B31_BASEL_RPT3 a where a.report_date = ?1 ", B31_BASEL_RPT3.class)
					.setParameter(1, df.parse(todate)).getResultList();

			T1Master4 = hs.createQuery("from B31_BASEL_RPT4 a where a.report_date = ?1 ", B31_BASEL_RPT4.class)
					.setParameter(1, df.parse(todate)).getResultList();

			T1Master5 = hs.createQuery("from B31_BASEL_RPT5 a where a.report_date = ?1 ", B31_BASEL_RPT5.class)
					.setParameter(1, df.parse(todate)).getResultList();
			T1Master6 = hs.createQuery("from B31_BASEL_RPT6 a where a.report_date = ?1 ", B31_BASEL_RPT6.class)
					.setParameter(1, df.parse(todate)).getResultList();
			T1Master7 = hs.createQuery("from B31_BASEL_RPT7 a where a.report_date = ?1 ", B31_BASEL_RPT7.class)
					.setParameter(1, df.parse(todate)).getResultList();

			T1Master8 = hs.createQuery("from B31_BASEL_RPT8 a where a.report_date = ?1 ", B31_BASEL_RPT8.class)
					.setParameter(1, df.parse(todate)).getResultList();

			T1Master9 = hs.createQuery("from B31_BASEL_RPT9 a where a.report_date = ?1 ", B31_BASEL_RPT9.class)
					.setParameter(1, df.parse(todate)).getResultList();
			T1Master10 = hs.createQuery("from B31_BASEL_RPT10 a where a.report_date = ?1 ", B31_BASEL_RPT10.class)
					.setParameter(1, df.parse(todate)).getResultList();
//System.out.println("T1Master2"+T1Master2.get(0).getDc);
	...
	public ModelAndView getB31BASELDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B31BASEL::reportcontent");
	...
	public File getFileB31BASEL(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B31.jrxml");
					}
