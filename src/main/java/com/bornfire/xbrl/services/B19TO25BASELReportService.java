...
import com.bornfire.xbrl.entities.BRBS.B19_TO_25_BASEL_RPT;
...
public class B19TO25BASELReportService {
	private static final Logger logger = LoggerFactory.getLogger(B19TO25BASELReportService.class);
	...
	public String preCheckB19TO25BASEL(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B19_TO_25_BASEL_RPT a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B19_TO_25_BASEL_RPT a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB19TO25BASELView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B19_TO_25_BASEL_RPT> T1rep = new ArrayList<B19_TO_25_BASEL_RPT>();
		// Query<Object[]> qr;

		List<B19_TO_25_BASEL_RPT> T1Master = new ArrayList<B19_TO_25_BASEL_RPT>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B19_TO_25_BASEL_RPT a where a.report_date = ?1 ", B19_TO_25_BASEL_RPT.class)
		...
		mv.setViewName("RR/B19TO25BASEL");
	...
	public ModelAndView getB19TO25BASELDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B19TO25BASEL::reportcontent");
	...
	public File getFileB19TO25BASEL(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B19_TO_25_BASEL.jrxml");
					}
