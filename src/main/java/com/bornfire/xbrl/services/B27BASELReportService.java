...
import com.bornfire.xbrl.entities.BRBS.B27_BASEL_RPT;
...
public class B27BASELReportService {
	private static final Logger logger = LoggerFactory.getLogger(B27BASELReportService.class);
	...
	public String preCheckB27BASEL(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B27_BASEL_RPT a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B27_BASEL_RPT a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB27BASELView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B27_BASEL_RPT> T1rep = new ArrayList<B27_BASEL_RPT>();
		// Query<Object[]> qr;

		List<B27_BASEL_RPT> T1Master = new ArrayList<B27_BASEL_RPT>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B27_BASEL_RPT a where a.report_date = ?1", B27_BASEL_RPT.class)
	...
	public ModelAndView getB27BASELDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B27BASEL::reportcontent");
	...
	public File getFileB27BASEL(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B27.jrxml");
					}
