...
import com.bornfire.xbrl.entities.BRBS.BASEL_B33_TABLE;
...
public class B33ReportService {
	private static final Logger logger = LoggerFactory.getLogger(B33ReportService.class);
	...
	public String preCheckB33(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_B33_TABLE a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_B33_TABLE a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
					} else {
	...
	public ModelAndView getB33View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BASEL_B33_TABLE> T1rep = new ArrayList<BASEL_B33_TABLE>();
			

			List<BASEL_B33_TABLE> T1Master = new ArrayList<BASEL_B33_TABLE>();
			...
			try {
				...
				T1Master = hs.createQuery("from BASEL_B33_TABLE a where a.report_date = ?1 ", BASEL_B33_TABLE.class)
	...
	public ModelAndView getB33Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"ReportB33::reportcontent");
				...
				try {
					...
					if (filetype.equals("detailexcel")) {
						if (dtltype.equals("report")) {
							...
							jasperFile = this.getClass().getResourceAsStream("/static/jasper/B33.jrxml");
						}
