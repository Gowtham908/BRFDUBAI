...
import com.bornfire.xbrl.entities.BRBS.BASEL_B15_TABLE;
...
public class B15ReportService {
	private static final Logger logger = LoggerFactory.getLogger(B15ReportService.class);
	...
	public String preCheckB15(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_B15_TABLE a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_B15_TABLE a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
					} else {
	...
	public ModelAndView getB15View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BASEL_B15_TABLE> T1rep = new ArrayList<BASEL_B15_TABLE>();
			

			List<BASEL_B15_TABLE> T1Master = new ArrayList<BASEL_B15_TABLE>();
			...
			try {
				...
				T1Master = hs.createQuery("from BASEL_B15_TABLE a where a.report_date = ?1 ", BASEL_B15_TABLE.class)
	...
	public ModelAndView getB15Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"ReportB15::reportcontent");
				...
				try {
					...
					if (filetype.equals("detailexcel")) {
						if (dtltype.equals("report")) {
							...
							jasperFile = this.getClass().getResourceAsStream("/static/jasper/B15A.jrxml");
						}
