...
import com.bornfire.xbrl.entities.BRBS.B14Reportentity;
import com.bornfire.xbrl.entities.BRBS.B14ServiceRepo;
...
public class B14ReportService  {
	private static final Logger logger = LoggerFactory.getLogger(B14ReportService .class);
	...
	public String preCheckB14(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B14Reportentity  a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B14Reportentity  a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB14View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B14Reportentity > T1rep = new ArrayList<B14Reportentity >();
		// Query<Object[]> qr;

		List<B14Reportentity > T1Master = new ArrayList<B14Reportentity >();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B14Reportentity  a where a.report_date = ?1 ", B14Reportentity .class)
	...
	public File getFileB14(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B14.jrxml");
					}
...
*/
	...
	public ModelAndView getB14currentDtl(String reportId, String fromdate, String todate, String currency,
			...
			mv.setViewName("RR"+"/"+"B14::reportcontent");
