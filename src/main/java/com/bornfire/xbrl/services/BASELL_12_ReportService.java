...
import com.bornfire.xbrl.entities.BRBS.BASELL_12_ENTITY;
...
public class BASELL_12_ReportService {
	private static final Logger logger = LoggerFactory.getLogger(BASELL_12_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASELL_12_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASELL_12_ENTITY a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB12View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BASELL_12_ENTITY> T1rep = new ArrayList<BASELL_12_ENTITY>();
			// Query<Object[]> qr;

			List<BASELL_12_ENTITY> T1Master = new ArrayList<BASELL_12_ENTITY>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BASELL_12_ENTITY a where a.report_date = ?1 ", BASELL_12_ENTITY .class)
	...
	public ModelAndView getB12currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B12A::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B12A.jrxml");
					}
