...
import com.bornfire.xbrl.entities.BRBS.BASEL_EUQTITYMR6_Entity;
...
public class BASELEQUALITY_ReportService{
  
	
	private static final Logger logger = LoggerFactory.getLogger(BASELEQUALITY_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from  BASEL_EUQTITYMR6_Entity a where a.report_date=?1")
					.setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from  BASEL_EUQTITYMR6_Entity a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
...
public ModelAndView getB35View(String reportId, String fromdate, String todate, String currency, String dtltype,
		Pageable pageable) {
		...
		List<BASEL_EUQTITYMR6_Entity> T1Master = new ArrayList<BASEL_EUQTITYMR6_Entity>();
	     List<BASEL_EUQTITYMR6_Entity> T1Master1 = new ArrayList<BASEL_EUQTITYMR6_Entity>(); 
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from  BASEL_EUQTITYMR6_Entity a where a.report_date = ?1 ", BASEL_EUQTITYMR6_Entity.class).setParameter(1, df.parse(todate)).getResultList();
	 ...
	 * }
	 */
public ModelAndView getB35currentDtl(String reportId, String fromdate, String todate, String currency,
	...
	mv.setViewName("RR"+"/"+"B35::reportcontent");
...
public File getFileB35(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		try {
			...
			if (filetype.equals("detailexcel")) {
				if (dtltype.equals("report")) {
					...
					jasperFile = this.getClass().getResourceAsStream("/static/jasper/b35.jrxml");
				}
