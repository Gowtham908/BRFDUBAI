...
import com.bornfire.xbrl.entities.BRBS.B25_BASEL_RPT;
...
public class B25BASELReportService {
	private static final Logger logger = LoggerFactory.getLogger(B25BASELReportService.class);
	...
	public String preCheckB25BASEL(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B25_BASEL_RPT a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B25_BASEL_RPT a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB25BASELView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B25_BASEL_RPT> T1rep = new ArrayList<B25_BASEL_RPT>();
		// Query<Object[]> qr;

		List<B25_BASEL_RPT> T1Master = new ArrayList<B25_BASEL_RPT>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B25_BASEL_RPT a where a.report_date = ?1", B25_BASEL_RPT.class)
	...
	public ModelAndView getB25BASELDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B25BASEL::reportcontent");
	...
	public File getFileB25BASEL(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B25.jrxml");
					}
