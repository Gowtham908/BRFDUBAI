...
import com.bornfire.xbrl.entities.BRBS.COMMODITYMR7_Entity;
...
public class BASCELMR6_ReportService {
	private static final Logger logger = LoggerFactory.getLogger(BASCELMR6_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from  COMMODITYMR7_Entity a where a.report_date=?1")
					.setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from  COMMODITYMR7_Entity a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
...
public ModelAndView getB36View(String reportId, String fromdate, String todate, String currency, String dtltype,
		Pageable pageable) {
		...
		List<COMMODITYMR7_Entity> T1Master = new ArrayList<COMMODITYMR7_Entity>();
	     List<COMMODITYMR7_Entity> T1Master1 = new ArrayList<COMMODITYMR7_Entity>(); 
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from  COMMODITYMR7_Entity a where a.report_date = ?1 ", COMMODITYMR7_Entity.class).setParameter(1, df.parse(todate)).getResultList();
	 ...
	 * }
	 */
public ModelAndView getB36currentDtl(String reportId, String fromdate, String todate, String currency,
	...
	mv.setViewName("RR"+"/"+"B36::reportcontent");
...
public File getFileB36(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		try {
			...
			if (filetype.equals("detailexcel")) {
				if (dtltype.equals("report")) {
					...
					jasperFile = this.getClass().getResourceAsStream("/static/jasper/Commodity_m7.jrxml");
				}
