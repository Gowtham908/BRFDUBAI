...
import com.bornfire.xbrl.entities.BRBS.BASELSECServiceRepo;
...
public class BASELSECReportService {
	private static final Logger logger = LoggerFactory.getLogger(BASELSECReportService.class);
	...
	@Autowired
	BASELSECServiceRepo BASELSECServiceRepo;
	...
	public String preCheckBASELSEC(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_SEC_REPORT_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_SEC_REPORT_ENTITY a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBASELSECView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<BASEL_SEC_REPORT_ENTITY> T1rep = new ArrayList<BASEL_SEC_REPORT_ENTITY>();
		// Query<Object[]> qr;

		List<BASEL_SEC_REPORT_ENTITY> T1Master = new ArrayList<BASEL_SEC_REPORT_ENTITY>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from BASEL_SEC_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_SEC_REPORT_ENTITY.class)
	...
	public ModelAndView getBASELSECDetails(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BASELSEC::reportcontent");
	...
	public File getFileBASELSEC(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BASELSEC.jrxml");
					}
