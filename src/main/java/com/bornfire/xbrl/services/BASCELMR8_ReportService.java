...
import com.bornfire.xbrl.entities.BRBS.BASEL_MR8_REPORT_ENTITY;
...
public class BASCELMR8_ReportService {
	private static final Logger logger = LoggerFactory.getLogger(BASCELMR8_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from  BASEL_MR8_REPORT_ENTITY a where a.report_date=?1")
					.setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from  BASEL_MR8_REPORT_ENTITY a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
...
public ModelAndView getMR8View(String reportId, String fromdate, String todate, String currency, String dtltype,
		Pageable pageable) {
		...
		List<BASEL_MR8_REPORT_ENTITY> T1Master = new ArrayList<BASEL_MR8_REPORT_ENTITY>();
		 List<BASEL_MR8_REPORT_ENTITY> T1Master1 = new ArrayList<BASEL_MR8_REPORT_ENTITY>(); 
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from  BASEL_MR8_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_MR8_REPORT_ENTITY.class).setParameter(1, df.parse(todate)).getResultList();
		...
		mv.setViewName("RR/ReportBASELMR8");
	 ...
	 * }
	 */
public ModelAndView getMR8currentDtl(String reportId, String fromdate, String todate, String currency,
	...
	mv.setViewName("RR"+"/"+"ReportBASELMR8::reportcontent");
...
public File getFileMR8(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		try {
			...
			if (filetype.equals("detailexcel")) {
				if (dtltype.equals("report")) {
					...
					jasperFile = this.getClass().getResourceAsStream("/static/jasper/MR8.jrxml");
				}
