...
import com.bornfire.xbrl.entities.BRBS.BASEL_B34_TABLE;
...
public class B34ReportService {
	private static final Logger logger = LoggerFactory.getLogger(B34ReportService.class);
	...
	public String preCheckB34(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_B34_TABLE a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_B34_TABLE a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
					} else {
	...
	public ModelAndView getB34View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BASEL_B34_TABLE> T1rep = new ArrayList<BASEL_B34_TABLE>();
			

			List<BASEL_B34_TABLE> T1Master = new ArrayList<BASEL_B34_TABLE>();
			...
			try {
				...
				T1Master = hs.createQuery("from BASEL_B34_TABLE a where a.report_date = ?1 ", BASEL_B34_TABLE.class)
	...
	public ModelAndView getB34Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"ReportB34::reportcontent");
				...
				try {
					...
					if (filetype.equals("detailexcel")) {
						if (dtltype.equals("report")) {
							...
							jasperFile = this.getClass().getResourceAsStream("/static/jasper/MR5A.jrxml");
						}
