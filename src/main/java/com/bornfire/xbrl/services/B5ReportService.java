...
import com.bornfire.xbrl.entities.BRBS.B5ServiceRepo;
import com.bornfire.xbrl.entities.BRBS.B5_1Reportentity;
import com.bornfire.xbrl.entities.BRBS.B5_2Reportentity;
import com.bornfire.xbrl.entities.BRBS.B5_3Reportentity;
import com.bornfire.xbrl.entities.BRBS.B5_4Reportentity;
import com.bornfire.xbrl.entities.BRBS.B5_5Reportentity;
import com.bornfire.xbrl.entities.BRBS.BASEL002AServiceRepo;
...
import com.bornfire.xbrl.entities.BRBS.BASEL_002_A_REPORT_ENTITY;
...
public class B5ReportService  {
	private static final Logger logger = LoggerFactory.getLogger(B5ReportService .class);
	...
	@Autowired
	BASEL002AServiceRepo BASEL002AServiceRepo;
	
	@Autowired
	B5ServiceRepo B5ServiceRepo;
	...
	public String preCheckB5(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B5_1Reportentity  a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B5_1Reportentity  a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB5View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B5_1Reportentity > T1rep = new ArrayList<B5_1Reportentity >();
		// Query<Object[]> qr;

		List<B5_1Reportentity > T1Master = new ArrayList<B5_1Reportentity >();
		
		List<B5_2Reportentity > T1Master1 = new ArrayList<B5_2Reportentity >();

		List<B5_3Reportentity > T1Master2 = new ArrayList<B5_3Reportentity >();
		
		List<B5_4Reportentity > T1Master3 = new ArrayList<B5_4Reportentity >();
		
		List<B5_5Reportentity > T1Master4 = new ArrayList<B5_5Reportentity >();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B5_1Reportentity  a where a.report_date = ?1 ", B5_1Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();

			
			T1Master1 = hs.createQuery("from B5_2Reportentity  a where a.report_date = ?1 ", B5_2Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master2 = hs.createQuery("from B5_3Reportentity  a where a.report_date = ?1 ", B5_3Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master3 = hs.createQuery("from B5_4Reportentity  a where a.report_date = ?1 ", B5_4Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();
			
			T1Master4 = hs.createQuery("from B5_5Reportentity  a where a.report_date = ?1 ", B5_5Reportentity .class)
					.setParameter(1, df.parse(todate)).getResultList();
	...
	public File getFileB5(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B5.jrxml");
					}
...
*/
	...
	public ModelAndView getB5currentDtl(String reportId, String fromdate, String todate, String currency,
			...
			mv.setViewName("RR"+"/"+"B5::reportcontent");
