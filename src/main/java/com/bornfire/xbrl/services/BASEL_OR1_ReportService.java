...
public class BASEL_OR1_ReportService {

	private static final Logger logger = LoggerFactory.getLogger(BASEL_OR1_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_OPRISK_OR1 a where a.report_date=?1").setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_OPRISK_OR1 a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
	...
	public ModelAndView getOR1currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		for (Object[] a : result) {
			...
			RBSTransactionMasterEntity py = new RBSTransactionMasterEntity(cust_id, cust_name, cust_type, cust_rating,
					acct_no, acct_name, tran_type, tran_sub_type, tran_date, tran_id, part_tran_id, part_tran_type,
					tran_crncy, tran_amt, tran_amt_orgin, tran_category, qtr_flg, entity_flg, del_flg, modify_flg,
					entry_date, modify_date, verify_date, entry_user, modify_user, verify_user, report_code,
					report_name, report_date, arch_flg, cell_mapping, process_owner, bank_id, cust_rating_date,
					tran_particular, tran_channel, cntry_res, cnty_incorp, cntry_oper, aml_code_1, aml_code_2,
					aml_code_3, aml_code_4, aml_code_5, aml_code_6, aml_code_7, aml_code_8, aml_code_9, aml_code_10,
					t1_report, t2_report, t4_report, t5_report, t6_report, t7_report, t9_report, t12a_report,
					t12b_report, t12c_report, t12d_report, t12e_report, t12f_report, t12g_report, t13a_report,
					t13b_report, t14a_report, t14b_report, t15a_report, t15b_report, t16a_report, t16b_report,
					t16c_report, t23_report, t26_report, t27_report, t29_report, t32_report, srl_num);
		...
		mv.setViewName("RR" + "/" + "ReportOR1::reportcontent");
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass()
								.getResourceAsStream("/static/jasper/Details.jrxml");
					} else {
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BASEL_OPRISK_OR1.jrxml");
					}
