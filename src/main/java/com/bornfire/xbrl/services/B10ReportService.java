...
import com.bornfire.xbrl.entities.BRBS.B10Reportentity;
import com.bornfire.xbrl.entities.BRBS.B10ServiceRepo;
...
public class B10ReportService  {
	private static final Logger logger = LoggerFactory.getLogger(B10ReportService .class);
	...
	public String preCheckB10(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from B10Reportentity  a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from B10Reportentity  a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB10View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<B10Reportentity > T1rep = new ArrayList<B10Reportentity >();
		// Query<Object[]> qr;

		List<B10Reportentity > T1Master = new ArrayList<B10Reportentity >();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from B10Reportentity  a where a.report_date = ?1 ", B10Reportentity .class)
	...
	public File getFileB10(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B10.jrxml");
					}
...
*/
	...
	public ModelAndView getB10currentDtl(String reportId, String fromdate, String todate, String currency,
			...
			mv.setViewName("RR"+"/"+"B10::reportcontent");
