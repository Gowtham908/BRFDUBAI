...
import com.bornfire.xbrl.entities.BRBS.CRMCR4Entity2;
import com.bornfire.xbrl.entities.BRBS.CRMCR4_Entity1;
...
public class B7_ReportService {
 
private static final Logger logger = LoggerFactory.getLogger(B7_ReportService.class);
...
public String preCheck(String reportid, String fromdate, String todate) {
	...
	try {
		...
		Long dtlcnt = (Long) hs.createQuery("select count(*) from  CRMCR4_Entity1 a where a.report_date=?1")
				.setParameter(1, dt9).getSingleResult();

		if (dtlcnt > 0) {
			logger.info("Getting No of records in Mod table :" + reportid);
			Long modcnt = (Long) hs.createQuery("select count(*) from  CRMCR4_Entity1 a").getSingleResult();
			if (modcnt > 0) {
				msg = "success";
			}
		} else {
...
public ModelAndView getB7View(String reportId, String fromdate, String todate, String currency, String dtltype,
	Pageable pageable) {
	...
	List<CRMCR4_Entity1> T1Master1 = new ArrayList<CRMCR4_Entity1>();
     List<CRMCR4Entity2> T1Master2 = new ArrayList<CRMCR4Entity2>(); 
	...
	//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
		...
		T1Master1 = hs.createQuery("from  CRMCR4_Entity1 a where a.report_date = ?1 ",
				CRMCR4_Entity1.class).setParameter(1, df.parse(todate)).getResultList();

		
		
		 T1Master2 = hs.createQuery("from CRMCR4Entity2 a where a.report_date = ?1 ",
				 CRMCR4Entity2.class) .setParameter(1, df.parse(todate)).getResultList();
 ...
 * }
 */
public ModelAndView getB7currentDtl(String reportId, String fromdate, String todate, String currency,
...
mv.setViewName("RR"+"/"+"B7::reportcontent");
...
public File getFileB7(String reportId, String fromdate, String todate, String currency, String dtltype,
	...
	try {
		...
		if (filetype.equals("detailexcel")) {
			if (dtltype.equals("report")) {
				...
				jasperFile = this.getClass().getResourceAsStream("/static/jasper/B7.jrxml");
			}
