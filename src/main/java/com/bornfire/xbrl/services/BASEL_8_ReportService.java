...
import com.bornfire.xbrl.entities.BRBS.BASEL_8_ENTITY1;
import com.bornfire.xbrl.entities.BRBS.BASEL_8_ENTITY2;
import com.bornfire.xbrl.entities.BRBS.BASEL_8_ENTITY3;
...
public class BASEL_8_ReportService {

	private static final Logger logger = LoggerFactory.getLogger(BASEL_8_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_8_ENTITY1 a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_8_ENTITY1 a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getB8View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BASEL_8_ENTITY1> T1Master = new ArrayList<BASEL_8_ENTITY1>();
			// Query<Object[]> qr;

			List<BASEL_8_ENTITY2> T2Master = new ArrayList<BASEL_8_ENTITY2>();
			List<BASEL_8_ENTITY3> T3Master = new ArrayList<BASEL_8_ENTITY3>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BASEL_8_ENTITY1 a where a.report_date = ?1 ", BASEL_8_ENTITY1 .class)
						.setParameter(1, df.parse(todate)).getResultList();
				T2Master = hs.createQuery("from  BASEL_8_ENTITY2 a where a.report_date = ?1 ", BASEL_8_ENTITY2 .class)
						.setParameter(1, df.parse(todate)).getResultList();
				T3Master = hs.createQuery("from  BASEL_8_ENTITY3 a where a.report_date = ?1 ", BASEL_8_ENTITY3 .class)
						.setParameter(1, df.parse(todate)).getResultList();
	...
	public ModelAndView getB8currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"B8::reportcontent");
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/B8.jrxml");
					}
