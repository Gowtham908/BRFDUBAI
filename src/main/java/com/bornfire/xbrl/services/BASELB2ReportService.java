...
import com.bornfire.xbrl.entities.BRBS.BASELB2ServiceRepo;
...
import com.bornfire.xbrl.entities.BRBS.BASEL_B2_REPORT_ENTITY;
import com.bornfire.xbrl.entities.BRBS.BASEL_SEC_REPORT_ENTITY;
...
public class BASELB2ReportService {
	private static final Logger logger = LoggerFactory.getLogger(BASELB2ReportService.class);
	...
	@Autowired
	BASELB2ServiceRepo BASELB2ServiceRepo;
	...
	public String preCheckBASELB2(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_B2_REPORT_ENTITY a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_B2_REPORT_ENTITY a ").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBASELB2View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
		...
		List<BASEL_B2_REPORT_ENTITY> T1rep = new ArrayList<BASEL_B2_REPORT_ENTITY>();
		// Query<Object[]> qr;

		List<BASEL_B2_REPORT_ENTITY> T1Master = new ArrayList<BASEL_B2_REPORT_ENTITY>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from BASEL_B2_REPORT_ENTITY a where a.report_date = ?1 ", BASEL_B2_REPORT_ENTITY.class)
	...
	public ModelAndView getBASELB2Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BASELB2::reportcontent");
	...
	public File getFileBASELB2(String reportId, String fromdate, String todate, String currency, String dtltype,
			...
			try {
				...
				if (filetype.equals("detailexcel")) {
					if (dtltype.equals("report")) {
						...
						jasperFile = this.getClass().getResourceAsStream("/static/jasper/BASELB2.jrxml");
					}
