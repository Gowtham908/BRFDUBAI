...
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE1;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE2;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE3;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE4;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE5;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE6;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE7;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE8;
import com.bornfire.xbrl.entities.BRBS.BASEL_B4_TABLE9;
...
public class B4ReportService {
	private static final Logger logger = LoggerFactory.getLogger(B4ReportService.class);
	...
	public String preCheckB4(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BASEL_B4_TABLE1 a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BASEL_B4_TABLE1 a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
					} else {
	...
	public ModelAndView getB4View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BASEL_B4_TABLE1> T1rep = new ArrayList<BASEL_B4_TABLE1>();
			

			List<BASEL_B4_TABLE1> T1Master = new ArrayList<BASEL_B4_TABLE1>();
			List<BASEL_B4_TABLE2> T1Master1 = new ArrayList<BASEL_B4_TABLE2>();
			List<BASEL_B4_TABLE3> T1Master2 = new ArrayList<BASEL_B4_TABLE3>();
			List<BASEL_B4_TABLE4> T1Master3 = new ArrayList<BASEL_B4_TABLE4>();
			List<BASEL_B4_TABLE5> T1Master4 = new ArrayList<BASEL_B4_TABLE5>();
			List<BASEL_B4_TABLE6> T1Master5 = new ArrayList<BASEL_B4_TABLE6>();
			List<BASEL_B4_TABLE7> T1Master6 = new ArrayList<BASEL_B4_TABLE7>();
			List<BASEL_B4_TABLE8> T1Master7 = new ArrayList<BASEL_B4_TABLE8>();
			List<BASEL_B4_TABLE9> T1Master8 = new ArrayList<BASEL_B4_TABLE9>();
			...
			try {
				...
				T1Master = hs.createQuery("from BASEL_B4_TABLE1 a where a.report_date = ?1 ", BASEL_B4_TABLE1.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master1 = hs.createQuery("from BASEL_B4_TABLE2 a where a.report_date = ?1 ", BASEL_B4_TABLE2.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master2 = hs.createQuery("from BASEL_B4_TABLE3 a where a.report_date = ?1 ", BASEL_B4_TABLE3.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master3 = hs.createQuery("from BASEL_B4_TABLE4 a where a.report_date = ?1 ", BASEL_B4_TABLE4.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master4 = hs.createQuery("from BASEL_B4_TABLE5 a where a.report_date = ?1 ", BASEL_B4_TABLE5.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master5 = hs.createQuery("from BASEL_B4_TABLE6 a where a.report_date = ?1 ", BASEL_B4_TABLE6.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master6 = hs.createQuery("from BASEL_B4_TABLE7 a where a.report_date = ?1 ", BASEL_B4_TABLE7.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master7 = hs.createQuery("from BASEL_B4_TABLE8 a where a.report_date = ?1 ", BASEL_B4_TABLE8.class)
						.setParameter(1, df.parse(todate)).getResultList();
				T1Master8 = hs.createQuery("from BASEL_B4_TABLE9 a where a.report_date = ?1 ", BASEL_B4_TABLE9.class)
						.setParameter(1, df.parse(todate)).getResultList();
	...
	public ModelAndView getB4Details(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"ReportB4::reportcontent");
				...
				try {
					...
					if (filetype.equals("detailexcel")) {
						if (dtltype.equals("report")) {
							...
							jasperFile = this.getClass().getResourceAsStream("/static/jasper/B4.jrxml");
						}
