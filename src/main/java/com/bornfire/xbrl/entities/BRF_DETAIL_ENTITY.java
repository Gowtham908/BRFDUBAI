...
@Entity
@Table(name="BRF1_ARCHEVE_DETAILS")
public class BRF_DETAIL_ENTITY {
	...
	public BRF_DETAIL_ENTITY(String sol_id, String acid, String foracid, String acct_name, String acct_no,
			BigDecimal accr_bal, Character nre_flg, String currency_code, Character del_flg, String create_user,
			String modify_user, String report_lable, String report_name, Date report_date, String version_control,
			String cust_id, String verify_user, String entity_flg, String remarks) {
		super();
		this.sol_id = sol_id;
		this.acid = acid;
		this.foracid = foracid;
