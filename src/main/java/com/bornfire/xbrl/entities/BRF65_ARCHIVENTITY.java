...
@Entity
@Table(name="BRF65_ARCHIVTABLE")
public class BRF65_ARCHIVENTITY {
	...
	public BRF65_ARCHIVENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
