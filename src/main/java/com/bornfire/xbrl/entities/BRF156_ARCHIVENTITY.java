...
@Entity
@Table(name="BRF156_ARCHIVTABLE")
public class BRF156_ARCHIVENTITY {
	...
	public BRF156_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
