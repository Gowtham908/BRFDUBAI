...
@Entity
@Table(name="BRF5_ARCHIVTABLE")

public class BRF5_ARCHIVENTITY {
	...
	public void setAct_balance_amt_ac(BigDecimal acct_balance_amt_ac) {
		this.acct_balance_amt_ac = acct_balance_amt_ac;
	}
	public BRF5_ARCHIVENTITY(String sol_id, String acid, String foracid, String acct_name, Character nre_flg,
			Character del_flg, String create_user, String modify_user, String report_label_1, String report_name_1,
			Date report_date, String version_control, String cust_id, String verify_user, Character entity_flg,
			String remarks, BigDecimal act_balance_amt_lc, BigDecimal eab_lc, String acct_crncy_code, String gl_code,
			String gl_sub_head_code, String gl_sub_head_desc, String country_of_incorp, String cust_type,
			String schm_code, String schm_type, String segment, String sub_segment, BigDecimal sector,
			String sub_sector, String sector_code, String group_id, String constitution_code, String country,
			String legal_entity_type, String constitution_desc, String purpose_of_advn, BigDecimal hni_networth,
			String turnover, String bacid, String report_addl_criteria_1, String report_addl_criteria_2,
			String report_addl_criteria_3, Date create_time, Date modify_time, Date verify_time, String maturity_date,
			String gender, Character nre_status, Character modify_flg, BigDecimal acct_balance_amt_ac) {
		super();
		this.sol_id = sol_id;
		this.acid = acid;
		this.foracid = foracid;
