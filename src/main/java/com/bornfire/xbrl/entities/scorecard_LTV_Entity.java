...
@Entity
@Table(name="scorecard_LIT")


public class scorecard_LTV_Entity {
	...
	public scorecard_LTV_Entity(String variable, BigDecimal group, String bin_value, BigDecimal partial_score,
