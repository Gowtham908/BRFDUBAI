...
@Entity
@Table(name="BRF104_ARCHIVTABLE")

public class BRF104_ARCHIV_ENTITY{
	...
	public BRF104_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
