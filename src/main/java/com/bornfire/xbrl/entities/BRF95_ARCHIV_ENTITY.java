...
@Entity
@Table(name="BRF95_ARCHIVTABLE")
public class BRF95_ARCHIV_ENTITY {
	...
	public BRF95_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
