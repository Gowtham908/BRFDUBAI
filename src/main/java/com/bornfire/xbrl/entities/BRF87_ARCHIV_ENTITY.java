...
@Entity
@Table(name="BRF87_ARCHIVTABLE")

public class BRF87_ARCHIV_ENTITY{
	...
	public BRF87_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
