...
@Entity
@Table(name = "BRF76_ARCHIVTABLE")
public class BRF76_ARCHIV_ENTITY {
	...
	public BRF76_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
