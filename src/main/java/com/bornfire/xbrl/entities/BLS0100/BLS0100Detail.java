...
@Entity
@Table(name = "BLS0100_MAST_TABLE")
public class BLS0100Detail {
	@Transient
	...
	public BLS0100Detail(String remarks, String acct_crncy_code, String glsh_code, String sch_type, String sch_code,
	...
	public BLS0100Detail(BLS0100Mod mod) {
	...
	public BLS0100Detail(BLS0100History hist) {

		this.bls0100DetailId = hist.getBls0100DetailId();
		this.acct_crncy_code = hist.getAcct_crncy_code();
		this.glsh_code = hist.getGlsh_code();
		this.sch_type = hist.getSch_type();
		this.sch_code = hist.getSch_code();
		this.cust_id = hist.getCust_id();
		this.acct_name = hist.getAcct_name();
		this.eab_date = hist.getEab_date();
		this.eab_bal = hist.getEab_bal();
