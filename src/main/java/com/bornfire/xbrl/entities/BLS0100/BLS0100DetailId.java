...
@Embeddable
public class BLS0100DetailId implements Serializable {
	...
	public BLS0100DetailId(String acctno, Date report_date) {
		super();
		this.acctno = acctno;
		this.report_date = report_date;
	}
	public BLS0100DetailId() {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BLS0100DetailId other = (BLS0100DetailId) obj;
		if (acctno == null) {
	...
	public BLS0100DetailId(BLS0100ModId mod) {
		super();
		this.acctno = mod.getAcctno();
