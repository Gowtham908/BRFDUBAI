...
@Entity
@Table(name="BLS0100_S1_RPT_TB")
public class BLS0100Report {
	
	@EmbeddedId
	private BLS0100RepId bls0100RepId;
	...
	public BLS0100RepId getBls0100RepId() {
		return bls0100RepId;
	}
	public void setBls0100RepId(BLS0100RepId bls0100RepId) {
		this.bls0100RepId = bls0100RepId;
	}
	...
	public BLS0100Report(BLS0100RepId bls0100RepId, String report_id, Date from_date, Date to_date, String version_no,
			String currency, String ref_code_desc, BigDecimal central_bank, BigDecimal banks, BigDecimal non_bnk,
			BigDecimal credit_unions, BigDecimal fin_gbc1, BigDecimal trusts_nr_gbc, BigDecimal insurance_corp,
			BigDecimal pension, BigDecimal investment, BigDecimal holding_comp, BigDecimal financial_aux,
			BigDecimal central_gov, BigDecimal state_loc_gov, BigDecimal non_finance_gbc, BigDecimal gbc2,
			BigDecimal public_non_fin_corp, BigDecimal oth_non_fin_corp, BigDecimal household,
			BigDecimal non_prof_institute, BigDecimal aff_nr, BigDecimal oth_nr, BigDecimal tot_lc,
			BigDecimal fc_central_bnk, BigDecimal fc_banks, BigDecimal fc_non_bnk, BigDecimal fc_credit_unions,
			BigDecimal fc_fin_gbc1, BigDecimal fc_trusts_nr_gbc, BigDecimal fc_insurance_corp, BigDecimal fc_pension,
			BigDecimal fc_investment, BigDecimal fc_holding_comp, BigDecimal fc_financial_aux,
			BigDecimal fc_central_gov, BigDecimal fc_state_loc_gov, BigDecimal fc_non_finance_gbc, BigDecimal fc_gbc2,
			BigDecimal fc_public_non_fin_corp, BigDecimal fc_oth_non_fin_corp, BigDecimal fc_household,
			BigDecimal fc_non_prof_institute, BigDecimal fc_aff_nr_bnk, BigDecimal fc_aff_nr_non_bnk,
			BigDecimal fc_oth_nr_bnk, BigDecimal fc_oth_nr_non_bnk, BigDecimal tot_fc, BigDecimal grand_tot) {
		super();
		this.bls0100RepId = bls0100RepId;
		this.report_id = report_id;
		this.from_date = from_date;
