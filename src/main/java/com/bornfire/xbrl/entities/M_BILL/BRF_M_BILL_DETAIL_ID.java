...
@Embeddable
public class BRF_M_BILL_DETAIL_ID implements Serializable{
	...
	public BRF_M_BILL_DETAIL_ID() {}
	public BRF_M_BILL_DETAIL_ID(String numero_piece, Date report_date) {
		super();
		this.numero_piece = numero_piece;
		this.report_date = report_date;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BRF_M_BILL_DETAIL_ID other = (BRF_M_BILL_DETAIL_ID) obj;
