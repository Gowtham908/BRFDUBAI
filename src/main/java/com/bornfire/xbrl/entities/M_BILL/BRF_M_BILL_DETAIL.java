...
@Entity
@Table(name="BRF_M_BILL_MAST_TB")
public class BRF_M_BILL_DETAIL {
	
	@EmbeddedId
	BRF_M_BILL_DETAIL_ID BRF_M_BILL_DETAIL_ID;
	@Transient
...
//	private String	numero_piece;
	...
	public BRF_M_BILL_DETAIL_ID getBRF_M_BILL_DETAIL_ID() {
			return BRF_M_BILL_DETAIL_ID;
		}


		public void setBRF_M_BILL_DETAIL_ID(BRF_M_BILL_DETAIL_ID bRF_M_BILL_DETAIL_ID) {
			BRF_M_BILL_DETAIL_ID = bRF_M_BILL_DETAIL_ID;
		}
...
*/
	...
	public BRF_M_BILL_DETAIL(com.bornfire.xbrl.entities.M_BILL.BRF_M_BILL_DETAIL_ID bRF_M_BILL_DETAIL_ID,
				String num_compta, String numero_piece, String op_finance, String op_evenement, String compte,
				String entite_groupe, String tiers, String description, String entite_operation, String poste,
				Date date_compta, String devise, String montant, String cours, String contrevaleur, String signe,
				String devise_compta, String entite, String flag_od, String tri_1, String tri_2, String tri_3,
				String type_instrument, String standard, Date report_date, String del_flg, String rcre_user_id,
	...
	public BRF_M_BILL_DETAIL() {}
	
	
	public BRF_M_BILL_DETAIL(BRF_M_BILL_MOD mod) {
		this.setBRF_M_BILL_DETAIL_ID(mod.getBRF_M_BILL_MOD_ID());
	...
	public BRF_M_BILL_DETAIL(BRF_M_BILL_History history) {
		this.setBRF_M_BILL_DETAIL_ID(history.getBRF_M_BILL_HistoryId());
		
		this.setNum_compta	(history.getNum_compta	());
		//this.setNumero_piece	(history.getNumero_piece	());
		this.setOp_finance	(history.getOp_finance	());
		this.setOp_evenement	(history.getOp_evenement	());
		this.setCompte	(history.getCompte	());
		this.setEntite_groupe	(history.getEntite_groupe	());
		this.setTiers	(history.getTiers	());
		this.setDescription	(history.getDescription	());
		this.setEntite_operation	(history.getEntite_operation	());
		this.setPoste	(history.getPoste	());
		this.setDate_compta	(history.getDate_compta	());
		this.setDevise	(history.getDevise	());
		this.setMontant	(history.getMontant	());
		this.setCours	(history.getCours	());
		this.setContrevaleur	(history.getContrevaleur	());
		this.setSigne	(history.getSigne	());
		this.setDevise_compta	(history.getDevise_compta	());
		this.setEntite	(history.getEntite	());
		this.setFlag_od	(history.getFlag_od());
		this.setDescription	(history.getDescription	());
		this.setTri_1	(history.getTri_1	());
		this.setTri_2	(history.getTri_2	());
		this.setTri_3	(history.getTri_3	());
		this.setType_instrument	(history.getType_instrument	());
		this.setStandard	(history.getStandard	());
		//this.setReport_date	(history.getReport_date	());
		this.setDel_flg	(history.getDel_flg	());
		this.setRcre_user_id	(history.getRcre_user_id	());
		this.setRcre_time	(history.getRcre_time	());
		this.setLchg_user_id	(history.getLchg_user_id	());
		this.setLchg_time	(history.getLchg_time	());
		this.setVerify_user_id	(history.getVerify_user_id	());
		this.setVerify_time	(history.getVerify_time	());

	}


	public BRF_M_BILL_DETAIL(String num_compta2, String numero_piece2, String op_finance2, String op_evenement2,
			String compte2, String entite_groupe2, String entite_groupe3, String tiers2, String description1,
			String entite_operation2, String poste2, Date date_compta2, String devise2, String montant2, String cours2,
			String contrevaleur2, String signe2, String devise_compta2, String entite2, String flag_od2,
			String description12, String tri_12, String tri_22, String tri_32, String type_instrument2,
			String standard2, Date report_date2, String del_flg2, String rcre_user_id2, String rcre_time2,
			String lchg_user_id2, String lchg_time2, String verify_user_id2, String verify_time2) {
