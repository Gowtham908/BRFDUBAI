...
@Entity
@Table(name="BRF_M_BILL_RPT_TB")
public class BRF_M_BILL_REPORT {
	@EmbeddedId
	BRF_M_BILL_REPORT_ID BRF_M_BILL_REPORT_ID;
	...
	public BRF_M_BILL_REPORT_ID getBRF_M_BILL_REPORT_ID() {
		return BRF_M_BILL_REPORT_ID;
	}
	public void setBRF_M_BILL_REPORT_ID(BRF_M_BILL_REPORT_ID bRF_M_BILL_REPORT_ID) {
		BRF_M_BILL_REPORT_ID = bRF_M_BILL_REPORT_ID;
	}
	...
	public BRF_M_BILL_REPORT(com.bornfire.xbrl.entities.M_BILL.BRF_M_BILL_REPORT_ID bRF_M_BILL_REPORT_ID,
