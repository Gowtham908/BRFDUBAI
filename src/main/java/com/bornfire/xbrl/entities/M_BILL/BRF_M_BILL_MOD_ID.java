...
import com.bornfire.xbrl.entities.FWD_REVEAL.BRF_FORWARD_REVEAL_MOD_Id;

@Embeddable
public class BRF_M_BILL_MOD_ID implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BRF_M_BILL_MOD_ID other = (BRF_M_BILL_MOD_ID) obj;
	...
	public BRF_M_BILL_MOD_ID() {}
	
	public BRF_M_BILL_MOD_ID(BigDecimal instance_code, Date report_date) {
		super();
		this.instance_code = instance_code;
		this.report_date = report_date;
	}
