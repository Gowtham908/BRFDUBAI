...
public class BRF_M_BILL_MANUAL {
	...
	private Date	report_date;
	 private String del_flg;
		...
		public BRF_M_BILL_MANUAL(String num_compta, String numero_piece, String op_finance, String op_evenement,
		...
		public BRF_M_BILL_MANUAL() {
			
		}
		public BRF_M_BILL_MANUAL(String num_compta, String numero_piece,String montant,
				String rcre_user_id, Date rcre_time) {
			this.num_compta = num_compta;
			this.numero_piece = numero_piece;
			this.montant = montant;
			this.rcre_user_id = rcre_user_id;
