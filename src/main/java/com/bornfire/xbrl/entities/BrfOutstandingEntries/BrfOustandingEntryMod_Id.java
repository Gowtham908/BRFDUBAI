...
@Embeddable
public class BrfOustandingEntryMod_Id implements Serializable{
	...
	public BrfOustandingEntryMod_Id(String num_operation, Date report_date) {
		super();
		this.num_operation = num_operation;
		this.report_date = report_date;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BrfOustandingEntryMod_Id other = (BrfOustandingEntryMod_Id) obj;
	...
	public BrfOustandingEntryMod_Id(BrfOutstandingEntryDetailId detail) {
		super();
