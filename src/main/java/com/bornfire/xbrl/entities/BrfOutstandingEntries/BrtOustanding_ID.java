...
@Embeddable
public class BrtOustanding_ID implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BrtOustanding_ID other = (BrtOustanding_ID) obj;
		return Objects.equals(num_operation, other.num_operation) && Objects.equals(report_date, other.report_date);
	
	}
	public BrtOustanding_ID(BigDecimal num_operation, Date report_date) {
		super();
		this.num_operation = num_operation;
		this.report_date = report_date;
	}
	public BrtOustanding_ID() {
		super();
