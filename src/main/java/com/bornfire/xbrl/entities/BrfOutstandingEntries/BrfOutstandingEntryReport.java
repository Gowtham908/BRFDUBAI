...
@Entity
@Table(name="BRF_OUTSTANDING_ENTRY_RPT_TB")
public class BrfOutstandingEntryReport {
	
	@EmbeddedId
	BrfOutstandingEntryReportId BrfOutstandingEntryReportId;
	...
	public BrfOutstandingEntryReportId getBrfOutstandingEntryReportId() {
		return BrfOutstandingEntryReportId;
	}
	public void setBrfOutstandingEntryReportId(BrfOutstandingEntryReportId brfOutstandingEntryReportId) {
		BrfOutstandingEntryReportId = brfOutstandingEntryReportId;
	}
	...
	public BrfOutstandingEntryReport(
			com.bornfire.xbrl.entities.BrfOutstandingEntries.BrfOutstandingEntryReportId brfOutstandingEntryReportId,
	...
	public BrfOutstandingEntryReport(
			com.bornfire.xbrl.entities.BrfOutstandingEntries.BrfOutstandingEntryReportId brfOutstandingEntryReportId2,
