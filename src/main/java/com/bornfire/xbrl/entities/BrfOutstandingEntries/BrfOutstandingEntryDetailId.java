...
@Embeddable
public class BrfOutstandingEntryDetailId implements Serializable{
	...
	public BrfOutstandingEntryDetailId(String num_operation, Date report_date) {
		super();
		this.num_operation = num_operation;
		this.report_date = report_date;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BrfOutstandingEntryDetailId other = (BrfOutstandingEntryDetailId) obj;
	...
	public BrfOutstandingEntryDetailId(BrfOustandingEntryMod_Id mod) {
		super();
		this.num_operation = mod.getNum_operation();
		this.report_date = mod.getReport_date();
		
	}
	public BrfOutstandingEntryDetailId(BigDecimal instance_code, Date report_date2) {
