...
public class BrfOutstandingEntryReportId implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BrfOutstandingEntryReportId other = (BrfOutstandingEntryReportId) obj;
   ...
   public BrfOutstandingEntryReportId() {
		
		// TODO Auto-generated constructor stub
	}
public BrfOutstandingEntryReportId(BigDecimal instance_code, Date report_date) {
	super();
	this.instance_code = instance_code;
	this.report_date = report_date;
}
public BrfOutstandingEntryReportId(Date report_date2, BigDecimal instance_code2) {
	// TODO Auto-generated constructor stub
}
