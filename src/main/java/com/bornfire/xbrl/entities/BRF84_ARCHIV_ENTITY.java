...
@Entity
@Table(name="BRF84_ARCHIVTABLE")
public class BRF84_ARCHIV_ENTITY {
	...
	public BRF84_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
