...
@Entity
@Table(name="BRF48_ARCHIVTABLE")

public class BRF48_ARCHIV_ENTITY{
	...
	public BRF48_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
