...
@Entity
@Table(name="BRF201_ARCHIVTABLE")

public class BRF201_ARCHIV_ENTITY 
{
	...
	public BRF201_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
