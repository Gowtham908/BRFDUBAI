...
@Entity
@Table(name="BRF36_ARCHIVTABLE")
public class BRF36_ARCHIV_ENTITY {
	...
	public BRF36_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
