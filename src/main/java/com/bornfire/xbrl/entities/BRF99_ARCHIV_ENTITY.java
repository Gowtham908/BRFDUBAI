...
@Entity
@Table(name="BRF99_ARCHIVTABLE")

public class BRF99_ARCHIV_ENTITY {
	...
	public BRF99_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
