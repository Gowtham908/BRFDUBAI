...
@Entity
@Table(name="ECL_MASTER_DATA_DISB_REC")
public class ECL_MDT_DIS_REC {
	...
	public ECL_MDT_DIS_REC(String sol_id, String cust_id, String map_key, String cust_name, String nature_asset_desc,
