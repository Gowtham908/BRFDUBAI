...
@Entity
@Table(name="BRF9_ARCHIVTABLE")
public class BRF9_ARCHIVENTITY {
	...
	public BRF9_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
