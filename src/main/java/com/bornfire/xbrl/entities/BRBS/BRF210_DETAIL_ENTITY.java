...
@Entity
@Table(name="BRF210_DETAILTABLE")

public class BRF210_DETAIL_ENTITY 
{
	...
	public BRF210_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
			...
			String nre_status, Date report_date, Date maturity_date, String version, String remarks, String gender) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.acct_name = acct_name;
