...
@Entity
@Table(name = "BRF13_MAPPING_TABLE")
public class BRF13_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF13_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
