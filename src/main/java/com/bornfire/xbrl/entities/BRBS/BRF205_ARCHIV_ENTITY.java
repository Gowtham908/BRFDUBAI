...
@Entity
@Table(name="BRF205_ARCHIVETABLE")

public class BRF205_ARCHIV_ENTITY {
	...
	public BRF205_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
