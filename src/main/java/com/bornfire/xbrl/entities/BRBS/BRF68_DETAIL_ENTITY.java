...
@Entity
@Table(name = "BRF68_DETAILTABLE")

public class BRF68_DETAIL_ENTITY {
	...
	public BRF68_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
			...
			String nre_status, Date report_date, String maturity_date, String version, String remarks, String gender,
			String nationality) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
