...
@Entity
@Table(name="BRF300_ARCHIVTABLE")
public class BRF300_ARCHIVENTITY {
	...
	public BRF300_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
