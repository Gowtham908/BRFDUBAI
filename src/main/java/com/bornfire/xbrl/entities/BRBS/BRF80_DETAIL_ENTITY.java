...
@Entity
@Table(name="BRF80_DETAILTABLE")
public class BRF80_DETAIL_ENTITY {
	...
	public BRF80_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			String nre_flg, String isin_code, String rating, String industry) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.act_balance_amt_lc = act_balance_amt_lc;
