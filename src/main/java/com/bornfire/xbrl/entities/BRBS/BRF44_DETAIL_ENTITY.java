...
@Entity
@Table(name = "BRF44_DETAILTABLE")
public class BRF44_DETAIL_ENTITY {
	...
	public BRF44_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
