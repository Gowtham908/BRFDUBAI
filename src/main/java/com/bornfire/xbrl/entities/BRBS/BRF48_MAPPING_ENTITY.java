...
@Entity
@Table(name = "BRF48_MAPPING_TABLE")
public class BRF48_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF48_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
