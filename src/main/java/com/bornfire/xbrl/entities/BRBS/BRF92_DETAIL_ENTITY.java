...
@Entity
@Table(name="BRF92_DETAILTABLE")

public class BRF92_DETAIL_ENTITY{
	...
	public BRF92_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
