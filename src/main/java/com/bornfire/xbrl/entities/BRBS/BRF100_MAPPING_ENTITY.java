...
@Entity
@Table(name = "BRF100_MAPPING_TABLE")
public class BRF100_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF100_MAPPING_ENTITY [acct_crncy_code=" + acct_crncy_code + ", acct_name=" + acct_name + ", acid="
	...
	public BRF100_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
