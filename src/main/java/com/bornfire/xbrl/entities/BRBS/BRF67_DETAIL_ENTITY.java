...
@Entity
@Table(name="BRF67_DETAILTABLE")
public class BRF67_DETAIL_ENTITY {
	...
	public BRF67_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
