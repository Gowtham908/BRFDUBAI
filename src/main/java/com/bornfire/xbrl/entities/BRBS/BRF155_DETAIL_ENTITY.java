...
@Entity
@Table(name="BRF155_DETAILTABLE")
public class BRF155_DETAIL_ENTITY {
	...
	public BRF155_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal act_balance_amt_ac,
