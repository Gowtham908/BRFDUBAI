...
@Entity
@Table(name = "BRF205_MAPPING_TABLE")
public class BRF205_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF205_MAPPING_ENTITY [acct_crncy_code=" + acct_crncy_code + ", acct_name=" + acct_name + ", acid="
				+ acid + ", act_balance_amt_lc=" + act_balance_amt_lc + ", bacid=" + bacid + ", constitution_code="
				...
				+ ", eab_lc=" + eab_lc + ", entity_flg=" + entity_flg + ", foracid=" + foracid + ", gender=" + gender
				+ ", gl_code=" + gl_code + ", gl_sub_head_code=" + gl_sub_head_code + ", gl_sub_head_desc="
				+ gl_sub_head_desc + ", group_id=" + group_id + ", hni_networth=" + hni_networth
				...
				+ ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc() + ", getBacid()=" + getBacid()
				+ ", getConstitution_code()=" + getConstitution_code() + ", getConstitution_desc()="
				+ getConstitution_desc() + ", getCountry()=" + getCountry() + ", getCountry_of_incorp()="
				+ getCountry_of_incorp() + ", getCreate_time()=" + getCreate_time() + ", getCreate_user()="
				+ getCreate_user() + ", getCust_id()=" + getCust_id() + ", getCust_type()=" + getCust_type()
				+ ", getDel_flg()=" + getDel_flg() + ", getEab_lc()=" + getEab_lc() + ", getEntity_flg()="
				+ getEntity_flg() + ", getForacid()=" + getForacid() + ", getGender()=" + getGender()
				+ ", getGl_code()=" + getGl_code() + ", getGl_sub_head_code()=" + getGl_sub_head_code()
				+ ", getGl_sub_head_desc()=" + getGl_sub_head_desc() + ", getGroup_id()=" + getGroup_id()
				+ ", getHni_networth()=" + getHni_networth() + ", getLegal_entity_type()=" + getLegal_entity_type()
				+ ", getMaturity_date()=" + getMaturity_date() + ", getModify_flg()=" + getModify_flg()
				+ ", getModify_time()=" + getModify_time() + ", getModify_user()=" + getModify_user()
				+ ", getNre_flg()=" + getNre_flg() + ", getNre_status()=" + getNre_status() + ", getPurpose_of_advn()="
				+ getPurpose_of_advn() + ", getRemarks()=" + getRemarks() + ", getReport_addl_criteria_1()="
				+ getReport_addl_criteria_1() + ", getReport_addl_criteria_2()=" + getReport_addl_criteria_2()
				+ ", getReport_addl_criteria_3()=" + getReport_addl_criteria_3() + ", getReport_date()="
				+ getReport_date() + ", getReport_label_1()=" + getReport_label_1() + ", getReport_name_1()="
				+ getReport_name_1() + ", getSchm_code()=" + getSchm_code() + ", getSchm_type()=" + getSchm_type()
				+ ", getSector()=" + getSector() + ", getSector_code()=" + getSector_code() + ", getSegment()="
				+ getSegment() + ", getSol_id()=" + getSol_id() + ", getSub_sector()=" + getSub_sector()
				+ ", getSub_segment()=" + getSub_segment() + ", getTurnover()=" + getTurnover() + ", getVerify_time()="
				+ getVerify_time() + ", getVerify_user()=" + getVerify_user() + ", getVersion()=" + getVersion()
				+ ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString()
				+ "]";
	}
	public BRF205_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			Character nre_flg, String acct_crncy_code2, String acct_name2, String acid2, BigDecimal act_balance_amt_lc,
			String bacid2, String constitution_code2, String constitution_desc2, String country2,
			String country_of_incorp2, Date create_time2, String create_user2, String cust_id2, String cust_type2,
			Character del_flg2, BigDecimal eab_lc, Character entity_flg2, String foracid2, String gender2,
			String gl_code2, String gl_sub_head_code2, String gl_sub_head_desc2, String group_id2,
			BigDecimal hni_networth2, String legal_entity_type2, Date maturity_date2, Character modify_flg2,
			Date modify_time2, String modify_user2, Character nre_flg2, Character nre_status2, String purpose_of_advn2,
			String remarks2, String report_addl_criteria_12, String report_addl_criteria_22,
			String report_addl_criteria_32, Date report_date2, String report_label_12, String report_name_12,
			String schm_code2, String schm_type2, String sector2, String sector_code2, String segment2, String sol_id2,
			String sub_sector2, String sub_segment2, String turnover2, Date verify_time2, String verify_user2,
			String version2) {
