...
@Entity
@Table(name="BRF155_ARCHIVTABLE")
public class BRF155_ARCHIV_ENTITY {
	...
	public BRF155_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal act_balance_amt_ac,
			...
			BigDecimal buy_usd, BigDecimal sell_aed, BigDecimal buy_aed, BigDecimal sell_usd) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.acct_name = acct_name;
