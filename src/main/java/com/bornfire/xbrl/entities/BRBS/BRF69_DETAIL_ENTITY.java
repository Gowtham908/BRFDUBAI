...
@Entity
@Table(name="BRF69_DETAILTABLE")

public class BRF69_DETAIL_ENTITY{
	...
	public BRF69_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
