...
@Entity
@Table(name = "BRF56_MAPPING_TABLE")
public class BRF56_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF56_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String remarks2, String gender2, String state, BigDecimal act_balance_amt_lc, String nationality) {
