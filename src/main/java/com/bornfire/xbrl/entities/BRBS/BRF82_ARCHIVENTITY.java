...
@Entity
@Table(name="BRF82_ARCHIVTABLE")
public class BRF82_ARCHIVENTITY {
	...
	public String toString() {
		return "BRF82_ARCHIVENTITY [acct_crncy_code=" + acct_crncy_code + ", acct_name=" + acct_name + ", acid=" + acid
				+ ", bacid=" + bacid + ", constitution_code=" + constitution_code + ", constitution_desc="
				...
				+ modify_flg + ", modify_time=" + modify_time + ", modify_user=" + modify_user + ", nre_status="
				+ nre_status + ", purpose_of_advn=" + purpose_of_advn + ", remarks=" + remarks
				...
				+ ", verify_user=" + verify_user + ", version=" + version + ", act_balance_amt_lc=" + act_balance_amt_lc
				+ ", eab_lc=" + eab_lc + ", getAcct_crncy_code()=" + getAcct_crncy_code() + ", getAcct_name()="
				+ getAcct_name() + ", getAcid()=" + getAcid() + ", getBacid()=" + getBacid()
				...
				+ ", getDel_flg()=" + getDel_flg() + ", getEntity_flg()=" + getEntity_flg() + ", getForacid()="
				+ getForacid() + ", getGender()=" + getGender() + ", getGl_code()=" + getGl_code()
				...
				+ ", getModify_user()=" + getModify_user() + ", getNre_status()=" + getNre_status()
				+ ", getPurpose_of_advn()=" + getPurpose_of_advn() + ", getRemarks()=" + getRemarks()
				...
				+ ", getVersion()=" + getVersion() + ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc()
				+ ", getEab_lc()=" + getEab_lc() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
				+ ", toString()=" + super.toString() + "]";
	}
	public BRF82_ARCHIVENTITY(String acct_crncy_code, String acct_name, String acid, String bacid,
			String constitution_code, String constitution_desc, String country, String country_of_incorp,
			Date create_time, String create_user, String cust_id, String cust_type, String del_flg, String entity_flg,
			String foracid, String gender, String gl_code, String gl_sub_head_code, String gl_sub_head_desc,
			String group_id, BigDecimal hni_networth, String legal_entity_type, String maturity_date, String modify_flg,
			Date modify_time, String modify_user, String nre_status, String purpose_of_advn, String remarks,
			String report_addl_criteria_1, String report_addl_criteria_2, String report_addl_criteria_3,
			Date report_date, String report_label_1, String report_name_1, String schm_code, String schm_type,
			BigDecimal sector, String sector_code, String segment, String sol_id, String sub_sector, String sub_segment,
			String turnover, Date verify_time, String verify_user, String version, BigDecimal act_balance_amt_lc,
			BigDecimal eab_lc) {
		super();
		this.acct_crncy_code = acct_crncy_code;
		this.acct_name = acct_name;
