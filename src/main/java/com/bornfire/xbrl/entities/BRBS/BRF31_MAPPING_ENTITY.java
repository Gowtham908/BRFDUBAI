...
@Entity
@Table(name = "BRF31_MAPPING_TABLE")
public class BRF31_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF31_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String version2, String remarks2, Character nre_flg2, String nationality) {
