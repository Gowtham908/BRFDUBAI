...
@Entity
@Table(name="BRF43B_DETAILTABLE")
public class BRF43_DETAIL_ENTITY {
	...
	public String toString() {
		return "BRF43_DETAIL_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
	...
	public BRF43_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
