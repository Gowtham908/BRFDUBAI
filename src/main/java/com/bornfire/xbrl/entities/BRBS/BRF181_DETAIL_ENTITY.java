...
@Entity
@Table(name ="BRF181_DETAILTABLE")
public class BRF181_DETAIL_ENTITY {
	...
	public BRF181_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
