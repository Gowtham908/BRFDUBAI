...
@Entity
@Table(name="BRF43_ARCHIVTABLE")
public class BRF43_ARCHIV_ENTITY {
	...
	public BRF43_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
