...
@Entity
@Table(name="BRF38A_DETAILTABLE")
@IdClass(BRF38_EMBEDDED_ID.class)
public class BRF38_DETAIL_ENTITY 
{
...
public BRF38_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
		...
		Date report_date, String maturity_date, String version, String remarks, String purpose_of_rem,
		String collection_code, BigDecimal srl_num) {
	super();
	this.cust_id = cust_id;
	this.foracid = foracid;
	this.acct_name = acct_name;
