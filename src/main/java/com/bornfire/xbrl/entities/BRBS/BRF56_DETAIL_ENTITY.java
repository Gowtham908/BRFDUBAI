...
@Entity
@Table(name ="BRF56_DETAILTABLE")
public class BRF56_DETAIL_ENTITY {
	...
	public BRF56_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
