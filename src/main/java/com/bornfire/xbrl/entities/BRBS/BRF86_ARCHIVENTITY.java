...
@Entity
@Table(name="BRF86_ARCHIVTABLE")
public class BRF86_ARCHIVENTITY {
	...
	public BRF86_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
