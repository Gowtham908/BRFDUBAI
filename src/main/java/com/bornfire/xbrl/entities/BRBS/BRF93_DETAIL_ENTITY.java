...
@Entity
@Table(name="BRF93A_DETAILTABLE")
@IdClass(BRF93_EMBEDDED_ID.class)

public class BRF93_DETAIL_ENTITY {
	...
	public BRF93_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
