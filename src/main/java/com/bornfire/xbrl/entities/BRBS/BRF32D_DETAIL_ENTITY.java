...
@Entity
@Table(name="BRF32D_DETAILTABLE")

public class BRF32D_DETAIL_ENTITY {
	...
	public BRF32D_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
