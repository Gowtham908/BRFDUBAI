...
@Entity
@Table(name="BRF66A_DETAILTABLE")
public class BRF66_DETAIL_ENTITY {
	...
	public BRF66_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
