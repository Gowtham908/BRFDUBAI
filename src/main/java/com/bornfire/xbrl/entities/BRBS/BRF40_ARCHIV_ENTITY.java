...
@Entity
@Table(name="BRF40_ARCHIVETABLE")

public class BRF40_ARCHIV_ENTITY {
	...
	public BRF40_ARCHIV_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
			...
			String verify_user, String version, String eco_act, String asst_cls, String asst_category) {
		super();
		this.acct_crncy_code = acct_crncy_code;
		this.acct_name = acct_name;
		this.acid = acid;
