...
@Entity
@Table(name="brf37b_archivtable")
public class BRF37B_ARCHIVENTITY {
	...
	public BRF37B_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
