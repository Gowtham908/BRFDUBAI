...
@Entity
@Table(name="BRF181_ARCHIVETABLE")
public class BRF181_ARCHIVEENTITY {
	...
	public BRF181_ARCHIVEENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
