...
@Entity
@Table(name = "BRF60_DETAILTABLE")
public class BRF60_DETAIL_ENTITY {
	...
	public BRF60_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
