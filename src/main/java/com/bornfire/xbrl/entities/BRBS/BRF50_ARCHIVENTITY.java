...
@Entity
@Table(name=" BRF50_ARCHIVTABLE")
public class BRF50_ARCHIVENTITY {
	...
	public BRF50_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
