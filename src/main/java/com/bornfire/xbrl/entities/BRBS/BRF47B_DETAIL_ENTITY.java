...
@Entity
@Table(name="BRF47B_DETAILTABLE")
public class BRF47B_DETAIL_ENTITY {
	...
	public BRF47B_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
