...
@Entity
@Table(name="BRF93_ARCHIVTABLE")
public class BRF93_ARCHIVENTITY {
	...
	public BRF93_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
