...
@Entity
@Table(name ="BRF8_ARCHIVTABLE")
public class BRF8_ARCHIV_ENTITY {
	...
	public BRF8_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
