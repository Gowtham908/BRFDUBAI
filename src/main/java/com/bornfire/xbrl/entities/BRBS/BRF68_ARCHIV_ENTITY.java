...
@Entity
@Table(name = "BRF68_ARCHIVTABLE")

public class BRF68_ARCHIV_ENTITY {
	...
	public BRF68_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
