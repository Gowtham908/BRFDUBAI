...
@Entity
@Table(name="BRF70_DETAILTABLE")

public class BRF70_DETAIL_ENTITY {
	...
	public BRF70_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
