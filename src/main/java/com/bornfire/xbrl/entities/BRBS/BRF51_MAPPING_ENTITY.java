...
@Entity
@Table(name = "BRF51_MAPPING_TABLE")
public class BRF51_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF51_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
