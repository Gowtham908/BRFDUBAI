...
@Entity
@Table(name="BRF37B_DETAILTABLE")

public class BRF37B_DETAIL_ENTITY 
{
	...
	public BRF37B_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
