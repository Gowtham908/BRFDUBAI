...
@Entity
@Table(name="BRF64_DETAILTABLE")

public class BRF64_DETAIL_ENTITY{
	...
	public BRF64_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
