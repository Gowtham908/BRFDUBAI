package com.bornfire.xbrl.entities.BRBS;
	...
	@Entity
	@Table(name ="ECL_BRF106_DETAIL_TABLE")
	public class BRF106_DETAIL_ENTITY {
		...
		public BRF106_DETAIL_ENTITY(String cust_id, String cust_name, String branch_name, String productname,
				...
				BigDecimal ecl_mgmt_overlay, BigDecimal specific_provision, BigDecimal interest_suspense,
				String country, String brf_1_classification, String brf_106, String basel_2_category,
				String provision_coverage, String mgmtoverlay, BigDecimal total_rwa, String report_lable,
				String report_addl_criteria1, String report_addl_criteria2, String facilityid) {
			super();
			this.cust_id = cust_id;
			this.cust_name = cust_name;
			this.branch_name = branch_name;
