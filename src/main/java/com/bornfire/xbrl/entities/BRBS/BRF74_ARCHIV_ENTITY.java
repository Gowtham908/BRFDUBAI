...
@Entity
@Table(name = "BRF74_ARCHIVTABLE")
public class BRF74_ARCHIV_ENTITY {
	...
	public BRF74_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
