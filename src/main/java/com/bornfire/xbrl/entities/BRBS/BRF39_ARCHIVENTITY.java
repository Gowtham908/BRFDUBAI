...
@Entity
@Table(name="BRF39_ARCHIVTABLE")

public class BRF39_ARCHIVENTITY 
{
	...
	public BRF39_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			BigDecimal equities, BigDecimal unfunded_os, BigDecimal ccf_equivalent_of_unfunded_os,
