...
@Entity
@Table(name = "BRF67_MAPPING_TABLE")
public class BRF67_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF67_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ ", remarks=" + remarks + ", act_balance_amt_lc=" + act_balance_amt_lc + ", gender=" + gender
				...
				+ getRemarks() + ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc() + ", getGender()=" + getGender()
				+ ", getNre_flg()=" + getNre_flg() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
				+ ", toString()=" + super.toString() + "]";
	}
	public BRF67_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String remarks2, BigDecimal act_balance_amt_lc, String gender2) {
