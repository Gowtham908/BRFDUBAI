...
@Entity
@Table(name="BRF80_ARCHIVTABLE")
public class BRF80_ARCHIVENTITY {
	...
	public BRF80_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
