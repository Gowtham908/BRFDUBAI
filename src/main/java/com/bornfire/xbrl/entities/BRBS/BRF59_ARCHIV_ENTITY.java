...
@Entity
@Table(name="BRF59_ARCHIVTABLE")
public class BRF59_ARCHIV_ENTITY {
	...
	public BRF59_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
