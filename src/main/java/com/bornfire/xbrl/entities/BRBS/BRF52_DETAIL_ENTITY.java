...
@Entity
@Table(name="BRF52_DETAILTABLE")
public class BRF52_DETAIL_ENTITY {
	...
	public BRF52_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
