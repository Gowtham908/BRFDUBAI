...
@Entity
@Table(name = "BRF74_DETAILTABLE")
public class BRF74_DETAIL_ENTITY {
	...
	public BRF74_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
