...
@Entity
@Table(name ="BRF204_ARCHIEVTABLE")
public class BRF204_ARCHIV_ENTITY {
	...
	public BRF204_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
