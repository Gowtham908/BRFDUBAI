...
@Entity
@Table(name = "BRF93B_MAPPING_TABLE")
public class BRF93_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF93_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				+ ", acct_crncy_code=" + acct_crncy_code + ", act_balance_amt_lc=" + act_balance_amt_lc + ", gl_code="
				+ gl_code + ", gl_sub_head_code=" + gl_sub_head_code + ", gl_sub_head_desc=" + gl_sub_head_desc
				+ ", country_of_incorp=" + country_of_incorp + ", cust_type=" + cust_type + ", schm_code=" + schm_code
				+ ", schm_type=" + schm_type + ", sol_id=" + sol_id + ", acid=" + acid + ", segment=" + segment
				+ ", sub_segment=" + sub_segment + ", sector=" + sector + ", sub_sector=" + sub_sector
				+ ", sector_code=" + sector_code + ", group_id=" + group_id + ", constitution_code=" + constitution_code
				+ ", country=" + country + ", legal_entity_type=" + legal_entity_type + ", constitution_desc="
				+ constitution_desc + ", purpose_of_advn=" + purpose_of_advn + ", hni_networth=" + hni_networth
				+ ", turnover=" + turnover + ", bacid=" + bacid + ", report_name_1=" + report_name_1
				+ ", report_label_1=" + report_label_1 + ", report_addl_criteria_1=" + report_addl_criteria_1
				+ ", report_addl_criteria_2=" + report_addl_criteria_2 + ", report_addl_criteria_3="
				+ report_addl_criteria_3 + ", create_user=" + create_user + ", create_time=" + create_time
				+ ", modify_user=" + modify_user + ", modify_time=" + modify_time + ", verify_user=" + verify_user
				+ ", verify_time=" + verify_time + ", entity_flg=" + entity_flg + ", modify_flg=" + modify_flg
				+ ", del_flg=" + del_flg + ", nre_status=" + nre_status + ", report_date=" + report_date
				+ ", maturity_date=" + maturity_date + ", version=" + version + ", remarks=" + remarks + ", gender="
				+ gender + ", purpose_of_rem=" + purpose_of_rem + ", collection_code=" + collection_code
				+ ", getCust_id()=" + getCust_id() + ", getForacid()=" + getForacid() + ", getAcct_name()="
				+ getAcct_name() + ", getAcct_crncy_code()=" + getAcct_crncy_code() + ", getAct_balance_amt_lc()="
				+ getAct_balance_amt_lc() + ", getGl_code()=" + getGl_code() + ", getGl_sub_head_code()="
				...
				+ getRemarks() + ", getGender()=" + getGender() + ", getPurpose_of_rem()=" + getPurpose_of_rem()
				+ ", getCollection_code()=" + getCollection_code() + ", getNre_flg()=" + getNre_flg() + ", getClass()="
				+ getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}
	public BRF93_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			BigDecimal act_balance_amt_lc, String gl_code2, String gl_sub_head_code2, String gl_sub_head_desc2,
			String country_of_incorp2, String cust_type2, String schm_code2, String schm_type2, String sol_id2,
			String acid2, String segment2, String sub_segment2, String sector2, String sub_sector2, String sector_code2,
			String group_id2, String constitution_code2, String country2, String legal_entity_type2,
			String constitution_desc2, String purpose_of_advn2, BigDecimal hni_networth2, String turnover2,
			String bacid2, String report_name_12, String report_label_12, String report_addl_criteria_12,
			String report_addl_criteria_22, String report_addl_criteria_32, String create_user2, Date create_time2,
			...
			String version2, String remarks2, String gender2, String purpose_of_rem, String collection_code) {
