...
@Entity
@Table(name = "BRF204_MAPPING_TABLE")
public class BRF204_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	private String	principle_of_operation;
	...
	public String getPrinciple_of_operation() {
		return principle_of_operation;
	}
	public void setPrinciple_of_operation(String principle_of_operation) {
		this.principle_of_operation = principle_of_operation;
	}
	...
	public String toString() {
		return "BRF204_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ ", version=" + version + ", remarks=" + remarks + ", nre_flg=" + nre_flg + ", principle_of_operation="
				+ principle_of_operation + ", act_balance_amt_lc=" + act_balance_amt_lc + ", getCust_id()="
				...
				+ getVersion() + ", getRemarks()=" + getRemarks() + ", getNre_flg()=" + getNre_flg()
				+ ", getPrinciple_of_operation()=" + getPrinciple_of_operation() + ", getAct_balance_amt_lc()="
				+ getAct_balance_amt_lc() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
				+ ", toString()=" + super.toString() + "]";
	}
	public BRF204_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			Character del_flg2, Character nre_status2, Date report_date2, Date maturity_date2, String gender2,
			String version2, String remarks2, Character nre_flg2, String principle_of_operation,
			BigDecimal act_balance_amt_lc) {
