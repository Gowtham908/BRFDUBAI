...
@Entity
@Table(name="BRF79_DETAILTABLE")
public class BRF79_DETAIL_ENTITY {
	...
	public BRF79_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
