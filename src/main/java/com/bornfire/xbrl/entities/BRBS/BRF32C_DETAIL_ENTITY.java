...
@Entity
@Table(name="BRF32C_DETAILTABLE")

public class BRF32C_DETAIL_ENTITY {
	...
	public BRF32C_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
