...
@Entity
@Table(name="BRF200_ARCHIVTABLE")
public class BRF200_ARCHIVENTITY {
	...
	public BRF200_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
