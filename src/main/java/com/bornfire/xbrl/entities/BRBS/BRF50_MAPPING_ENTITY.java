...
@Entity
@Table(name = "BRF50_MAPPING_TABLE")
public class BRF50_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	private BigDecimal	interest_expenses;
	...
	public BigDecimal getInterest_expenses() {
		return interest_expenses;
	}
	public void setInterest_expenses(BigDecimal interest_expenses) {
		this.interest_expenses = interest_expenses;
	}
	@Override
	public String toString() {
		return "BRF50_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ ", purpose_of_advn=" + purpose_of_advn + ", networth=" + networth + ", turnover=" + turnover
				...
				+ ", version=" + version + ", remarks=" + remarks + ", nre_flg=" + nre_flg + ", act_balance_amt_lc="
				+ act_balance_amt_lc + ", interest_expenses=" + interest_expenses + ", getCust_id()=" + getCust_id()
				+ ", getForacid()=" + getForacid() + ", getAcct_name()=" + getAcct_name() + ", getAcct_crncy_code()="
				+ getAcct_crncy_code() + ", getGl_code()=" + getGl_code() + ", getGl_sub_head_code()="
				+ getGl_sub_head_code() + ", getGl_sub_head_desc()=" + getGl_sub_head_desc()
				+ ", getCountry_of_incorp()=" + getCountry_of_incorp() + ", getCust_type()=" + getCust_type()
				+ ", getSchm_code()=" + getSchm_code() + ", getSchm_type()=" + getSchm_type() + ", getSol_id()="
				+ getSol_id() + ", getAcid()=" + getAcid() + ", getSegment()=" + getSegment() + ", getSub_segment()="
				+ getSub_segment() + ", getSector()=" + getSector() + ", getSub_sector()=" + getSub_sector()
				+ ", getSector_code()=" + getSector_code() + ", getGroup_id()=" + getGroup_id()
				...
				+ getConstitution_desc() + ", getPurpose_of_advn()=" + getPurpose_of_advn() + ", getNetworth()="
				+ getNetworth() + ", getTurnover()=" + getTurnover() + ", getBacid()=" + getBacid()
				...
				+ ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc() + ", getInterest_expenses()="
				+ getInterest_expenses() + ", getHni_networth()=" + getHni_networth() + ", getClass()=" + getClass()
				+ ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}
	public BRF50_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String purpose_of_advn2, BigDecimal networth, String turnover2, String bacid2, String report_name_12,
			...
			String version2, String remarks2, Character nre_flg2, BigDecimal act_balance_amt_lc,
			BigDecimal interest_expenses) {
