...
@Entity
@Table(name="BRF001_ARCHIVTABLE")
public class BRF0001_ARCHIV_ENTITY {
	...
	public BRF0001_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
