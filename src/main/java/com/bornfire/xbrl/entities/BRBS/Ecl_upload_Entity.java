...
@Entity
@Table(name="ECL_REPORT_TABLE")
public class Ecl_upload_Entity {
	...
	public Ecl_upload_Entity(String facilityid, String customerid, String cust_name, String branch_name,
