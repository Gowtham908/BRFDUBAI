...
@Entity
@Table(name = "BRF31_DETAILTABLE")
public class BRF31_DETAIL_ENTITY {
		...
		public BRF31_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
