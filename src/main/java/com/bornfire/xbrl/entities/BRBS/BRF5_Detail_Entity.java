...
@Entity
@Table(name="BRF5_DETAILTABLE")
@IdClass(BRF005_EMBEDDED_ID.class)
public class BRF5_Detail_Entity {
	...
	public BRF5_Detail_Entity(String sol_id, String acid, String foracid, String acct_name, Character nre_flg,
			...
			String remarks, BigDecimal acct_balance_amt_lc, BigDecimal eab_lc, String acct_crncy_code, String gl_code,
