...
@Entity
@Table(name = "BRF10_MAPPING_TABLE")
public class BRF10_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	private String	maturity_date_diff;
	...
	public String getMaturity_date_diff() {
		return maturity_date_diff;
	}
	public void setMaturity_date_diff(String maturity_date_diff) {
		this.maturity_date_diff = maturity_date_diff;
	}
	public BRF10_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
