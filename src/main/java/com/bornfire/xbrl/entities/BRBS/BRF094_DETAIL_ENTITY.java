...
@Entity
@Table(name="BRF94A_DETAILTABLE")
@IdClass(BRF94_EMBEDDED_ID.class)

public class BRF094_DETAIL_ENTITY {
	...
	public String toString() {
		return "BRF94_DETAILENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", act_balance_amt_lc="
				+ act_balance_amt_lc + ", eab_lc=" + eab_lc + ", acct_name=" + acct_name + ", acct_crncy_code="
				+ acct_crncy_code + ", gl_code=" + gl_code + ", gl_sub_head_code=" + gl_sub_head_code
				+ ", gl_sub_head_desc=" + gl_sub_head_desc + ", country_of_incorp=" + country_of_incorp + ", cust_type="
				+ cust_type + ", schm_code=" + schm_code + ", schm_type=" + schm_type + ", sol_id=" + sol_id + ", acid="
				+ acid + ", segment=" + segment + ", sub_segment=" + sub_segment + ", sector=" + sector
				+ ", sub_sector=" + sub_sector + ", sector_code=" + sector_code + ", group_id=" + group_id
				+ ", constitution_code=" + constitution_code + ", country=" + country + ", legal_entity_type="
				+ legal_entity_type + ", constitution_desc=" + constitution_desc + ", purpose_of_advn="
				+ purpose_of_advn + ", hni_networth=" + hni_networth + ", turnover=" + turnover + ", bacid=" + bacid
				+ ", report_name_1=" + report_name_1 + ", report_label_1=" + report_label_1
				...
				+ ", version=" + version + ", remarks=" + remarks + ", purpose_of_rem=" + purpose_of_rem
				+ ", collection_code=" + collection_code + ", getCust_id()=" + getCust_id() + ", getForacid()="
				+ getForacid() + ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc() + ", getEab_lc()=" + getEab_lc()
				...
				+ getVersion() + ", getRemarks()=" + getRemarks() + ", getPurpose_of_rem()=" + getPurpose_of_rem()
				+ ", getCollection_code()=" + getCollection_code() + ", getClass()=" + getClass() + ", hashCode()="
				+ hashCode() + ", toString()=" + super.toString() + "]";
	}
	public BRF094_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			String purpose_of_rem, String collection_code) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.act_balance_amt_lc = act_balance_amt_lc;
