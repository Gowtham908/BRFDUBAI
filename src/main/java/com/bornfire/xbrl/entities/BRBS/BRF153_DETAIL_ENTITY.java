...
@Entity
@Table(name="BRF153_DETAILTABLE")

public class BRF153_DETAIL_ENTITY {
	...
	public BRF153_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
