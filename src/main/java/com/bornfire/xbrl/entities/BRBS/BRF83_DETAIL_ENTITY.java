...
@Entity
@Table(name="BRF83_DETAILTABLE")
public class BRF83_DETAIL_ENTITY {
	...
	public BRF83_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
