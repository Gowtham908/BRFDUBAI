...
@Entity
@Table(name="BRF59A_DETAILTABLE")
@IdClass(BRF59_EMBEDDED_ID.class)

public class BRF59_DETAIL_ENTITY {
	...
	public BRF59_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			String verify_user, Date verify_time, String entity_flg, String modify_flg, Character del_flg,
