...
@Entity
@Table(name="BRF39B_DETAILTABLE")

public class BRF39_DETAIL_ENTITY 
{
	...
	public BigDecimal getUnfundes_os() {
		return unfunded_os;
	}
	public void setUnfundes_os(BigDecimal unfundes_os) {
		this.unfunded_os = unfundes_os;
	}
	...
	public BRF39_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			String nre_flg, BigDecimal funded_os, BigDecimal credit_risk, BigDecimal debt_securities,
			BigDecimal equities, BigDecimal unfundes_os, BigDecimal ccf_equivalent_of_unfunded_os,
			BigDecimal ccf_equivalent_limits) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.act_balance_amt_lc = act_balance_amt_lc;
