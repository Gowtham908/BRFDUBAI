...
@Entity
@Table(name="BRF99_DETAILTABLE")

public class BRF99_DETAIL_ENTITY {
	...
	public BRF99_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
