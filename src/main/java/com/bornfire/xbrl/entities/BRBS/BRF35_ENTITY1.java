...
@Entity
@Table(name="BRF35_SUMMARYTABLE1")
public class BRF35_ENTITY1 {
	...
	public String toString() {
		return "BRF35_ENTITY1 [country_party=" + country_party + ", branch=" + branch + ", head_office=" + head_office
				...
				+ ", report_code=" + report_code + ", report_submit_date=" + report_submit_date
				+ ", getCountry_party()=" + getCountry_party() + ", getBranch()=" + getBranch() + ", getHead_office()="
				+ getHead_office() + ", getDue_from_placements()=" + getDue_from_placements()
				+ ", getDue_to_borrowing()=" + getDue_to_borrowing() + ", getDue_from_remaining()="
				+ getDue_from_remaining() + ", getDue_to_bremaining()=" + getDue_to_bremaining() + ", getReport_date()="
	...
	public BRF35_ENTITY1(String country_party, String branch, String head_office, BigDecimal due_from_placements,
