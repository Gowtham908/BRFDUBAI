...
@Entity
@Table(name="BRF100_DETAILTABLE")

public class BRF100_DETAIL_ENTITY {
	...
	public BRF100_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
