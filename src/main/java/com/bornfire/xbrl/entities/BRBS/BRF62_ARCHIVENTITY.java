...
@Entity
@Table(name="BRF62_ARCHIVTABLE")
public class BRF62_ARCHIVENTITY {
	...
	public BRF62_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
