...
@Entity
@Table(name="BRF73_ARCHIVTABLE")
public class BRF73_ARCHIVENTITY {
	...
	public BRF73_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
