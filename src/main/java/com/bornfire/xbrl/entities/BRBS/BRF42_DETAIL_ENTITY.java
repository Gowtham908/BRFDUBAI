...
@Entity
@Table(name="BRF42_DETAILTABLE")
public class BRF42_DETAIL_ENTITY {
	...
	public BRF42_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
