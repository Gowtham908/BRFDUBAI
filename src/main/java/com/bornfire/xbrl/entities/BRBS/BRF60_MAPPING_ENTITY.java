...
@Entity
@Table(name = "BRF60_MAPPING_TABLE")
public class BRF60_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF60_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
	...
	public BRF60_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
