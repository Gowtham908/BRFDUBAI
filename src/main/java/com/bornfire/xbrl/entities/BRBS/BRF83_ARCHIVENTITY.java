...
@Entity
@Table(name="BRF83_ARCHIVTABLE")
public class BRF83_ARCHIVENTITY {
	...
	public BRF83_ARCHIVENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
