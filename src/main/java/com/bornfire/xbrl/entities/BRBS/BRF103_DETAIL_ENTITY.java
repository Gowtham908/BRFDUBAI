...
@Entity
@Table(name="BRF103_DETAILTABLE")

public class BRF103_DETAIL_ENTITY {
	...
	public BRF103_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
			...
			Date modify_time, String modify_user, String nre_flg, String nre_status, String purpose_of_advn,
			BigDecimal eab_lc, String remarks, String report_addl_criteria_1, String report_addl_criteria_2,
			String report_addl_criteria_3, Date report_date, String report_label_1, String report_name_1,
			String schm_code, String schm_type, String sector, String sector_code, String segment, String sol_id,
			String sub_sector, String sub_segment, String turnover, Date verify_time, String verify_user,
			String version) {
		super();
		this.acct_crncy_code = acct_crncy_code;
		this.acct_name = acct_name;
