...
@Entity
@Table(name="BRF67_ARCHIVTABLE")
public class BRF67_ARCHIVENTITY {
	...
	public BRF67_ARCHIVENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
