...
@Entity
@Table(name="BRF202_DETAILTABLE")

public class BRF202_DETAIL_ENTITY {
	...
	public BRF202_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
