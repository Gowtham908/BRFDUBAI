...
@Entity
@Table(name = "BRF34_MAPPING_TABLE")
public class BRF34_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF34_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
