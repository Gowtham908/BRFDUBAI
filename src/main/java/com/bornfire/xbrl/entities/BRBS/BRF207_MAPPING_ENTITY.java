...
@Entity
@Table(name = "BRF207_MAPPING_TABLE")
public class BRF207_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF207_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ ", remarks=" + remarks + ", gender=" + gender + ", getCust_id()=" + getCust_id() + ", getForacid()="
				+ getForacid() + ", getAcct_name()=" + getAcct_name() + ", getAcct_crncy_code()=" + getAcct_crncy_code()
				...
				+ getRemarks() + ", getGender()=" + getGender() + ", getNre_flg()=" + getNre_flg() + ", getClass()="
				+ getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}
	public BRF207_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String remarks2, String gender2) {
