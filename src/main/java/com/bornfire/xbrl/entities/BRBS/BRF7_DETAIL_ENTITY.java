...
@Entity
@Table(name ="BRF7_DETAILTABLE")
public class BRF7_DETAIL_ENTITY {
	...
	public BRF7_DETAIL_ENTITY(String sol_id, String acid, String foracid, String acct_name, Character nre_flg,
			...
			String gender, Character nre_status, Character modify_flg) {
		super();
		this.sol_id = sol_id;
		this.acid = acid;
		this.foracid = foracid;
