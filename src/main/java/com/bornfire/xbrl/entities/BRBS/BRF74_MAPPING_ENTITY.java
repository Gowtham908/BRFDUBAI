...
@Entity
@Table(name = "BRF74_MAPPING_TABLE")
public class BRF74_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	private BigDecimal	act_int_rate;
	private String eco_act;
	private BigDecimal subsegment;
	private BigDecimal segmentation_class;
	private BigDecimal int_rate;
	private BigDecimal bg_amt;
	...
	public BigDecimal getAct_int_rate() {
		return act_int_rate;
	}
	public void setAct_int_rate(BigDecimal act_int_rate) {
		this.act_int_rate = act_int_rate;
	}
	public String getEco_act() {
		return eco_act;
	}
	public void setEco_act(String eco_act) {
		this.eco_act = eco_act;
	}
	public BigDecimal getSubsegment() {
		return subsegment;
	}
	public void setSubsegment(BigDecimal subsegment) {
		this.subsegment = subsegment;
	}
	public BigDecimal getSegmentation_class() {
		return segmentation_class;
	}
	public void setSegmentation_class(BigDecimal segmentation_class) {
	...
	public BigDecimal getBg_amt() {
		return bg_amt;
	}
	public void setBg_amt(BigDecimal bg_amt) {
		this.bg_amt = bg_amt;
	}
	...
	public BRF74_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			BigDecimal act_int_rate, String eco_act, BigDecimal subsegment, BigDecimal segmentation_class,
			BigDecimal int_rate, BigDecimal bg_amt, String nationality, BigDecimal sanct_amt) {
