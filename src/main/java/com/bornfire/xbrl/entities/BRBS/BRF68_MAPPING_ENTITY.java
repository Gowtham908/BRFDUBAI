...
@Entity
@Table(name = "BRF68_MAPPING_TABLE")
public class BRF68_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF68_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ ", del_flg=" + del_flg + ", nre_status=" + nre_status + ", nre_flg=" + nre_flg + ", report_date="
				+ report_date + ", maturity_date=" + maturity_date + ", gender=" + gender + ", version=" + version
				+ ", remarks=" + remarks + ", nationality=" + nationality + ", getCust_id()=" + getCust_id()
				+ ", getForacid()=" + getForacid() + ", getAcct_name()=" + getAcct_name() + ", getAcct_crncy_code()="
				+ getAcct_crncy_code() + ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc() + ", getGl_code()="
				+ getGl_code() + ", getGl_sub_head_code()=" + getGl_sub_head_code() + ", getGl_sub_head_desc()="
				...
				+ getDel_flg() + ", getNre_status()=" + getNre_status() + ", getNre_flg()=" + getNre_flg()
				+ ", getReport_date()=" + getReport_date() + ", getMaturity_date()=" + getMaturity_date()
				+ ", getGender()=" + getGender() + ", getVersion()=" + getVersion() + ", getRemarks()=" + getRemarks()
				+ ", getNationality()=" + getNationality() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
				+ ", toString()=" + super.toString() + "]";
	}
	public BRF68_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			Character modify_flg2, Character del_flg2, Character nre_status2, Character nre_flg2, Date report_date2,
			Date maturity_date2, String gender2, String version2, String remarks2, String nationality) {
