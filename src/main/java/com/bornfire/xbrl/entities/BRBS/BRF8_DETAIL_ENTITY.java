...
@Entity
@Table(name ="BRF8_DETAILTABLE")
public class BRF8_DETAIL_ENTITY {
	...
	public BRF8_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
