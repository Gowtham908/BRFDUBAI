...
@Entity
@Table(name ="BRF12_DETAILTABLE")
public class BRF12_DETAIL_ENTITY {
	...
	public BRF12_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
