...
@Entity
@Table(name="BRF77_ARCHIVTABLE")
public class BRF77_ARCHIVENTITY {
	...
	public BRF77_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
