...
@Entity
@Table(name="BRF78_ARCHIVTABLE")
public class BRF78_ARCHIV_ENTITY {
	...
	public BRF78_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
