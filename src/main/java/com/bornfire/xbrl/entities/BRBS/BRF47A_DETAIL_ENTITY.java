...
@Entity
@Table(name="BRF47A_DETAILTABLE")
public class BRF47A_DETAIL_ENTITY {
	...
	public BRF47A_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
