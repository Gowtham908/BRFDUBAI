...
@Entity
@Table(name="BRF85_DETAILTABLE")
public class BRF85_DETAIL_ENTITY {
	...
	public BRF85_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
