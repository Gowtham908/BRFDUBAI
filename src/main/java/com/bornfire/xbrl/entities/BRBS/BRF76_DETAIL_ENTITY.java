...
@Entity
@Table(name = "BRF76_DETAILTABLE")
public class BRF76_DETAIL_ENTITY {
	...
	public BRF76_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
