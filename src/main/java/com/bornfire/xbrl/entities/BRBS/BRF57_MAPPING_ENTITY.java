...
@Entity
@Table(name = "BRF57_MAPPING_TABLE")
public class BRF57_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF57_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
	...
	public BRF57_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			String gl_code, String gl_sub_head_code, String schm_code, String schm_type, String sol_id, String acid,
			...
			Character nre_status, Date report_date, String version, String remarks, String cust_type,
			String constitution_code, String legal_entity_type, String constitution_desc, String segment,
			String sub_segment, String sector, String sub_sector, String group_id, String purpose_of_advn,
			String gl_sub_head_desc, String sector_code, BigDecimal hni_networth, String turnover, String bacid,
			Date maturity_date, String country_of_incorp, String country, String gender, Character nre_flg) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.acct_name = acct_name;
