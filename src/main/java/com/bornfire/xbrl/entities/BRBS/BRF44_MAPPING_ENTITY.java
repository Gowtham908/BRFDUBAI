...
@Entity
@Table(name = "BRF44_MAPPING_TABLE")
public class BRF44_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF44_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			Character nre_status2, String purpose_of_advn2, BigDecimal eab_lc, String remarks2,
