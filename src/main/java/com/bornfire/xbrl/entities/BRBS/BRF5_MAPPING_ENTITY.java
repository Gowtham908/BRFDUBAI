...
@Entity
@Table(name = "BRF5_MAPPING_TABLE")
public class BRF5_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF5_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ ", report_date=" + report_date + ", maturity_date=" + maturity_date + ", gender=" + gender
				+ ", version=" + version + ", remarks=" + remarks + ", nre_flg=" + nre_flg + ", getCust_id()="
				+ getCust_id() + ", getForacid()=" + getForacid() + ", getAcct_name()=" + getAcct_name()
				+ ", getAcct_crncy_code()=" + getAcct_crncy_code() + ", getGl_code()=" + getGl_code()
				+ ", getGl_sub_head_code()=" + getGl_sub_head_code() + ", getGl_sub_head_desc()="
				+ getGl_sub_head_desc() + ", getCountry_of_incorp()=" + getCountry_of_incorp() + ", getCust_type()="
				+ getCust_type() + ", getSchm_code()=" + getSchm_code() + ", getSchm_type()=" + getSchm_type()
				+ ", getSol_id()=" + getSol_id() + ", getAcid()=" + getAcid() + ", getSegment()=" + getSegment()
				+ ", getSub_segment()=" + getSub_segment() + ", getSector()=" + getSector() + ", getSub_sector()="
				+ getSub_sector() + ", getSector_code()=" + getSector_code() + ", getGroup_id()=" + getGroup_id()
				+ ", getConstitution_code()=" + getConstitution_code() + ", getCountry()=" + getCountry()
				+ ", getLegal_entity_type()=" + getLegal_entity_type() + ", getConstitution_desc()="
				+ getConstitution_desc() + ", getPurpose_of_advn()=" + getPurpose_of_advn() + ", getHni_networth()="
				+ getHni_networth() + ", getTurnover()=" + getTurnover() + ", getBacid()=" + getBacid()
				+ ", getReport_name_1()=" + getReport_name_1() + ", getReport_label_1()=" + getReport_label_1()
				...
				+ ", getMaturity_date()=" + getMaturity_date() + ", getGender()=" + getGender() + ", getVersion()="
				+ getVersion() + ", getRemarks()=" + getRemarks() + ", getNre_flg()=" + getNre_flg() + ", getClass()="
				+ getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}
	public BRF5_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
			String gl_sub_head_code, String gl_sub_head_desc, String country_of_incorp, String cust_type,
			String schm_code, String schm_type, String sol_id, String acid, String segment, String sub_segment,
			String sector, String sub_sector, String sector_code, String group_id, String constitution_code,
			String country, String legal_entity_type, String constitution_desc, String purpose_of_advn,
			BigDecimal hni_networth, String turnover, String bacid, String report_name_1, String report_label_1,
			...
			Date verify_time, Character entity_flg, Character modify_flg, Character del_flg, Character nre_status,
			Date report_date, Date maturity_date, String gender, String version, String remarks, Character nre_flg,
			String cust_id2, String foracid2, String acct_name2, String acct_crncy_code2, String gl_code2,
			String gl_sub_head_code2, String gl_sub_head_desc2, String country_of_incorp2, String cust_type2,
			String schm_code2, String schm_type2, String sol_id2, String acid2, String segment2, String sub_segment2,
			String sector2, String sub_sector2, String sector_code2, String group_id2, String constitution_code2,
			String country2, String legal_entity_type2, String constitution_desc2, String purpose_of_advn2,
			BigDecimal hni_networth2, String turnover2, String bacid2, String report_name_12, String report_label_12,
			String report_addl_criteria_12, String report_addl_criteria_22, String report_addl_criteria_32,
			String create_user2, Date create_time2, String modify_user2, Date modify_time2, String verify_user2,
			Date verify_time2, Character entity_flg2, Character modify_flg2, Character del_flg2, Character nre_status2,
			Date report_date2, Date maturity_date2, String gender2, String version2, String remarks2,
			Character nre_flg2) {
