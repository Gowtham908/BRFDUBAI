...
@Entity
@Table(name = "BRF210_MAPPING_TABLE")
public class BRF210_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public void setAcct_balance_amt_lc(BigDecimal act_balance_amt_lc) {
		this.act_balance_amt_lc = act_balance_amt_lc;
	}
	public BRF210_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
			...
			Date verify_time, Character entity_flg, Character modify_flg, Character del_flg, Character nre_status, Date report_date,
			Date maturity_date, String gender, String version, String remarks, Character nre_flg,
