...
@Entity
@Table(name = "BRF70_MAPPING_TABLE")
public class BRF70_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF70_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
