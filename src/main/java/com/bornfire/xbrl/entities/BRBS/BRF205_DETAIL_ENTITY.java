...
@Entity
@Table(name="BRF205_DETAILTABLE")

public class BRF205_DETAIL_ENTITY {
	...
	public BRF205_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
