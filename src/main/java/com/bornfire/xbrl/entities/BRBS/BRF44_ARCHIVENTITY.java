...
@Entity
@Table(name="BRF44_ARCHIVETABLE")

public class BRF44_ARCHIVENTITY {
	...
	public BRF44_ARCHIVENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
