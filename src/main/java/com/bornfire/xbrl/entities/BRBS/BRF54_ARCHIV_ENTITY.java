...
@Entity
@Table(name="BRF54_ARCHIVTABLE")

public class BRF54_ARCHIV_ENTITY {
	...
	public BRF54_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
