...
@Entity
@Table(name = "BRF88_DETAILTABLE")
public class BRF88_DETAIL_ENTITY {
	...
	public BRF88_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
