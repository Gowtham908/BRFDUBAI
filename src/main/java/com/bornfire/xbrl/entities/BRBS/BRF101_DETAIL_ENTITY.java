...
@Entity
@Table(name="BRF101_DETAILTABLE")
public class BRF101_DETAIL_ENTITY {
	...
	public BRF101_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
