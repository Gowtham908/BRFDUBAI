...
@Entity
@Table(name="BRF13_ARCHIVTABLE")
public class BRF13_ARCHIV_ENTITY {
	...
	public BRF13_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
