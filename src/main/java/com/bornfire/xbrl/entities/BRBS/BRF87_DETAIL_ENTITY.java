...
@Entity
@Table(name="BRF87_DETAILTABLE")

public class BRF87_DETAIL_ENTITY{
	...
	public BRF87_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
