...
@Entity
@Table(name="BRF154_ARCHIVTABLE")
public class BRF154_ARCHIV_ENTITY {
	...
	public BRF154_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
