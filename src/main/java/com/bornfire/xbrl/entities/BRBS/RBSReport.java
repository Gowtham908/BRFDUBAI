...
@Entity
@Table(name = "BRBS_RPT_MAST")
public class RBSReport {
	...
	private Date	cur_qtr_start_date;
	private Date	cur_qtr_end_date;
	...
	public Date getCur_qtr_start_date() {
		return cur_qtr_start_date;
	}
	public void setCur_qtr_start_date(Date cur_qtr_start_date) {
		this.cur_qtr_start_date = cur_qtr_start_date;
	}
	public Date getCur_qtr_end_date() {
		return cur_qtr_end_date;
	}
	public void setCur_qtr_end_date(Date cur_qtr_end_date) {
		this.cur_qtr_end_date = cur_qtr_end_date;
	}
