...
@Entity
@Table(name="BRF62_DETAILTABLE")
public class BRF62_DETAILENTITY {
	...
	public BRF62_DETAILENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
