...
@Entity
@Table(name="BRF49_DETAILTABLE")

public class BRF49_DETAIL_ENTITY{
	...
	public BRF49_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
