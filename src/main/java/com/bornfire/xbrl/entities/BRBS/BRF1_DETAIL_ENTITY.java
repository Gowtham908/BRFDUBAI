...
@Entity
@Table(name ="BRF1_DETAILTABLE")
public class BRF1_DETAIL_ENTITY {
	...
	public BRF1_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
