...
@Entity
@Table(name="BRF96_DETAILTABLE")

public class BRF96_DETAIL_ENTITY{
	...
	public BRF96_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
