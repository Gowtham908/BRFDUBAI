...
@Entity
@Table(name="BRF65A_DETAILTABLE")
public class BRF65_DETAIL_ENTITY {
	...
	public BRF65_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
			String gl_sub_head_code, String schm_code, String schm_type, String sol_id, String acid, String bacid,
			...
			Date report_date, String version, String remarks, String legal_entity_type, String constitution_desc,
			String segment, String sub_segment, BigDecimal sector, String sub_sector, String group_id,
			String purpose_of_advn, String gl_sub_head_desc, String sector_code, BigDecimal hni_networth,
			String turnover, String maturity_date, String country_of_incorp, String nre_status,
			String constitution_code, String cust_type, String country, String gender, BigDecimal eab_lc,
