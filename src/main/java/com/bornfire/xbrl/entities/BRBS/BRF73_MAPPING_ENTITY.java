...
@Entity
@Table(name = "BRF73_MAPPING_TABLE")
public class BRF73_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF73_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
