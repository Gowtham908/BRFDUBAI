...
@Entity
@Table(name = "BRF32B_MAPPING_TABLE")
public class BRF32_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BigDecimal getRank_num() {
		return rank_num;
	}
	public void setRank_num(BigDecimal rank_num) {
	...
	public BRF32_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String version2, String remarks2, Character nre_flg2, BigDecimal act_balance_amt_lc, BigDecimal rank_num,
			String asst_cls, String asst_category) {
