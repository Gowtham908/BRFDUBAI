...
@Entity
@Table(name="BRF152_DETAILTABLE")

public class BRF152_DETAIL_ENTITY {
	...
	public BigDecimal getAmt_ac() {
		return amt_ac;
	}
	public void setAmt_ac(BigDecimal amt_ac) {
		this.amt_ac = amt_ac;
	}
	...
	public BRF152_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
			BigDecimal act_balance_amt_lc, BigDecimal amt_ac, String acct_crncy_code, String gl_code,
			...
			BigDecimal sector, String sub_sector, String sector_code, String group_id, String constitution_code,
			...
			Date verify_time, String entity_flg, String modify_flg, String del_flg, String nre_status, Date report_date,
			String maturity_date, String version, String gender, String remarks) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.acct_name = acct_name;
