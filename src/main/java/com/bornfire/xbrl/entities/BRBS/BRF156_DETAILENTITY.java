...
@Entity
@Table(name="BRF156_DETAILTABLE")

public class BRF156_DETAILENTITY 
{
	...
	public BRF156_DETAILENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
