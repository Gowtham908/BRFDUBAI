...
@Entity
@Table(name="BRF94_ARCHIVTABLE")
public class BRF094_ARCHIV_ENTITY {
	...
	public BRF094_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
