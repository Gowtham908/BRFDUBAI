...
@Entity
@Table(name="BRF78_DETAILTABLE")

public class BRF78_DETAIL_ENTITY{
	...
	public BRF78_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
