...
@Entity
@Table(name="BRF34_DETAILTABLE")

public class BRF34_DETAIL_ENTITY {
	...
	public BRF34_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
