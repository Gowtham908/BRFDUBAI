...
@Entity
@Table(name = "BRF44_ARCHIVTABLE")
public class BRF44_ARCHIV_ENTITY {
	...
	public BRF44_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
