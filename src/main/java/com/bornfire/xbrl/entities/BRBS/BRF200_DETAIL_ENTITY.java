...
@Entity
@Table(name="BRF200_DETAILTABLE")

public class BRF200_DETAIL_ENTITY {
	...
	public BRF200_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
