...
@Entity
@Table(name="BRF32_SPLIT_TABLE")

public class BRF32_DETAIL_ENTITY {
	...
	public BRF32_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
