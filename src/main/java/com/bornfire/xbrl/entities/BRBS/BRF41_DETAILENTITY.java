...
@Entity
@Table(name="BRF41_DETAILTABLE")
public class BRF41_DETAILENTITY {
	...
	public BRF41_DETAILENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
