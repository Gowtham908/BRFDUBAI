...
@Entity
@Table(name="BRF106_ARCHIVTABLE")
public class BRF106_ARCHIVENTITY {
	...
	public BRF106_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
