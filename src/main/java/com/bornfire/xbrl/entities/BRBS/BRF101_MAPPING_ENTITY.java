...
@Entity
@Table(name = "BRF101_MAPPING_TABLE")
public class BRF101_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF101_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ report_addl_criteria_2 + ", report_addl_criteria_3=" + report_addl_criteria_3
				+ ", act_balance_amt_lc=" + act_balance_amt_lc + ", create_user=" + create_user + ", create_time="
				+ create_time + ", modify_user=" + modify_user + ", modify_time=" + modify_time + ", verify_user="
				+ verify_user + ", verify_time=" + verify_time + ", entity_flg=" + entity_flg + ", modify_flg="
				+ modify_flg + ", del_flg=" + del_flg + ", nre_status=" + nre_status + ", report_date=" + report_date
				+ ", maturity_date=" + maturity_date + ", gender=" + gender + ", version=" + version + ", remarks="
				+ remarks + ", nre_flg=" + nre_flg + ", getCust_id()=" + getCust_id() + ", getForacid()=" + getForacid()
				...
				+ getReport_addl_criteria_3() + ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc()
	...
	public BRF101_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String report_addl_criteria_32, BigDecimal act_balance_amt_lc, String create_user2, Date create_time2,
			String modify_user2, Date modify_time2, String verify_user2, Date verify_time2, Character entity_flg2,
			Character modify_flg2, Character del_flg2, Character nre_status2, Date report_date2, Date maturity_date2,
			String gender2, String version2, String remarks2, Character nre_flg2) {
