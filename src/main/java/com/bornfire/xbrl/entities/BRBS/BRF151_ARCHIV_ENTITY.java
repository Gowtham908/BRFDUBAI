...
@Entity
@Table(name ="BRF151_ARCHIVTABLE")
public class BRF151_ARCHIV_ENTITY {
	...
	public BRF151_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
