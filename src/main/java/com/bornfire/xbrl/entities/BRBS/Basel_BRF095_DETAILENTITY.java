...
@Entity
@Table(name="BRF095_DETAILTABLE")
public class Basel_BRF095_DETAILENTITY {
	...
	public Basel_BRF095_DETAILENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
	...
	public Basel_BRF095_DETAILENTITY() {
		super();
