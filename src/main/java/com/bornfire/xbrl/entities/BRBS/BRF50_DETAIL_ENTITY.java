...
@Entity
@Table(name="BRF50_DETAILTABLE")
public class BRF50_DETAIL_ENTITY {
	...
	public BRF50_DETAIL_ENTITY() {
		super();
		// TODO Auto-generated constructor stub
	}
	public BRF50_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			String nre_flg, BigDecimal interest_expenses) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.act_balance_amt_lc = act_balance_amt_lc;
