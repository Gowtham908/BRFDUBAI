...
@Entity
@Table(name = "BRF64_MAPPING_TABLE")
public class BRF64_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF64_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
