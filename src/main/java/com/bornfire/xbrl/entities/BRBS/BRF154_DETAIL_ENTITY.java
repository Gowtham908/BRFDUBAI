...
@Entity
@Table(name="BRF154B_DETAILTABLE")
public class BRF154_DETAIL_ENTITY {
	...
	public String toString() {
		return "BRF154_DETAIL_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				+ ", eab_lc=" + eab_lc + ", act_balance_amt_lc=" + act_balance_amt_lc + ", acct_crncy_code="
				...
				+ ", remarks=" + remarks + ", getCust_id()=" + getCust_id() + ", getForacid()=" + getForacid()
				+ ", getAcct_name()=" + getAcct_name() + ", getEab_lc()=" + getEab_lc() + ", getAct_balance_amt_lc()="
				+ getAct_balance_amt_lc() + ", getAcct_crncy_code()=" + getAcct_crncy_code() + ", getGl_code()="
	...
	public BRF154_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
			...
			String nre_status, Date report_date, String maturity_date, String version, String remarks) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.acct_name = acct_name;
