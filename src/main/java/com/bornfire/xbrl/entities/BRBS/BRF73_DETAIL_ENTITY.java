...
@Entity
@Table(name="BRF73_DETAILTABLE")
public class BRF73_DETAIL_ENTITY {
	...
	public BRF73_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
