...
@Entity
@Table(name="BRF33_ARCHIVTABLE")
public class BRF33_ARCHIV_ENTITY {
	...
	public BRF33_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
