...
@Entity
@Table(name="BRF40_DETAILTABLE")

public class BRF40_DETAIL_ENTITY {
	...
	public BRF40_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
