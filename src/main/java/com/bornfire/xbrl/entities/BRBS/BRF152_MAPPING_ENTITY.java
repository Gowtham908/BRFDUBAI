...
@Entity
@Table(name = "BRF152_MAPPING_TABLE")
public class BRF152_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	private BigDecimal	act_balance_amt_ac;
	...
	public BigDecimal getAct_balance_amt_ac() {
		return act_balance_amt_ac;
	}
	public void setAct_balance_amt_ac(BigDecimal act_balance_amt_ac) {
		this.act_balance_amt_ac = act_balance_amt_ac;
	}
	...
	public String toString() {
		return "BRF152_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				+ ", acct_crncy_code=" + acct_crncy_code + ", gl_code=" + gl_code + ", gl_sub_head_code="
				+ gl_sub_head_code + ", gl_sub_head_desc=" + gl_sub_head_desc + ", country_of_incorp="
				+ country_of_incorp + ", cust_type=" + cust_type + ", schm_code=" + schm_code + ", schm_type="
				+ schm_type + ", sol_id=" + sol_id + ", acid=" + acid + ", segment=" + segment + ", sub_segment="
				+ sub_segment + ", sector=" + sector + ", sub_sector=" + sub_sector + ", sector_code=" + sector_code
				+ ", group_id=" + group_id + ", constitution_code=" + constitution_code + ", country=" + country
				+ ", legal_entity_type=" + legal_entity_type + ", constitution_desc=" + constitution_desc
				+ ", purpose_of_advn=" + purpose_of_advn + ", hni_networth=" + hni_networth + ", turnover=" + turnover
				+ ", bacid=" + bacid + ", report_name_1=" + report_name_1 + ", report_label_1=" + report_label_1
				+ ", report_addl_criteria_1=" + report_addl_criteria_1 + ", report_addl_criteria_2="
				+ report_addl_criteria_2 + ", report_addl_criteria_3=" + report_addl_criteria_3 + ", create_user="
				...
				+ entity_flg + ", modify_flg=" + modify_flg + ", del_flg=" + del_flg + ", nre_status=" + nre_status
				+ ", report_date=" + report_date + ", maturity_date=" + maturity_date + ", version=" + version
				+ ", remarks=" + remarks + ", gender=" + gender + ", act_balance_amt_lc=" + act_balance_amt_lc
				+ ", act_balance_amt_ac=" + act_balance_amt_ac + ", currency1=" + currency1 + ", currency2=" + currency2
				+ ", days=" + days + ", getCust_id()=" + getCust_id() + ", getForacid()=" + getForacid()
				+ ", getAcct_name()=" + getAcct_name() + ", getAcct_crncy_code()=" + getAcct_crncy_code()
				+ ", getGl_code()=" + getGl_code() + ", getGl_sub_head_code()=" + getGl_sub_head_code()
				+ ", getGl_sub_head_desc()=" + getGl_sub_head_desc() + ", getCountry_of_incorp()="
				+ getCountry_of_incorp() + ", getCust_type()=" + getCust_type() + ", getSchm_code()=" + getSchm_code()
				+ ", getSchm_type()=" + getSchm_type() + ", getSol_id()=" + getSol_id() + ", getAcid()=" + getAcid()
				+ ", getSegment()=" + getSegment() + ", getSub_segment()=" + getSub_segment() + ", getSector()="
				+ getSector() + ", getSub_sector()=" + getSub_sector() + ", getSector_code()=" + getSector_code()
				+ ", getGroup_id()=" + getGroup_id() + ", getConstitution_code()=" + getConstitution_code()
				+ ", getCountry()=" + getCountry() + ", getLegal_entity_type()=" + getLegal_entity_type()
				+ ", getConstitution_desc()=" + getConstitution_desc() + ", getPurpose_of_advn()="
				+ getPurpose_of_advn() + ", getHni_networth()=" + getHni_networth() + ", getTurnover()=" + getTurnover()
				+ ", getBacid()=" + getBacid() + ", getReport_name_1()=" + getReport_name_1() + ", getReport_label_1()="
				+ getReport_label_1() + ", getReport_addl_criteria_1()=" + getReport_addl_criteria_1()
				+ ", getReport_addl_criteria_2()=" + getReport_addl_criteria_2() + ", getReport_addl_criteria_3()="
				+ getReport_addl_criteria_3() + ", getCreate_user()=" + getCreate_user() + ", getCreate_time()="
				+ getCreate_time() + ", getModify_user()=" + getModify_user() + ", getModify_time()=" + getModify_time()
				...
				+ getDel_flg() + ", getNre_status()=" + getNre_status() + ", getReport_date()=" + getReport_date()
				+ ", getMaturity_date()=" + getMaturity_date() + ", getVersion()=" + getVersion() + ", getRemarks()="
				+ getRemarks() + ", getGender()=" + getGender() + ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc()
				+ ", getAct_balance_amt_ac()=" + getAct_balance_amt_ac() + ", getCurrency1()=" + getCurrency1()
				+ ", getCurrency2()=" + getCurrency2() + ", getDays()=" + getDays() + ", getNre_flg()=" + getNre_flg()
				+ ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString()
				+ "]";
	}
	public BRF152_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			Character nre_flg, String cust_id2, String foracid2, String acct_name2, String acct_crncy_code2,
			String gl_code2, String gl_sub_head_code2, String gl_sub_head_desc2, String country_of_incorp2,
			String cust_type2, String schm_code2, String schm_type2, String sol_id2, String acid2, String segment2,
			String sub_segment2, String sector2, String sub_sector2, String sector_code2, String group_id2,
			String constitution_code2, String country2, String legal_entity_type2, String constitution_desc2,
			String purpose_of_advn2, BigDecimal hni_networth2, String turnover2, String bacid2, String report_name_12,
			String report_label_12, String report_addl_criteria_12, String report_addl_criteria_22,
			String report_addl_criteria_32, String create_user2, Date create_time2, String modify_user2,
			Date modify_time2, String verify_user2, Date verify_time2, Character entity_flg2, Character modify_flg2,
			Character del_flg2, Character nre_status2, Date report_date2, Date maturity_date2, String version2,
			String remarks2, String gender2, BigDecimal act_balance_amt_lc, BigDecimal act_balance_amt_ac,
			String currency1, String currency2, String days) {
