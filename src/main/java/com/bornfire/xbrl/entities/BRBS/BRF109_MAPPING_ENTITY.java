...
@Entity
@Table(name = "BRF109_MAPPING_TABLE")
public class BRF109_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF109_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				+ ", acct_crncy_code=" + acct_crncy_code + ", gl_code=" + gl_code + ", gl_sub_head_code="
				+ gl_sub_head_code + ", schm_code=" + schm_code + ", schm_type=" + schm_type + ", sol_id=" + sol_id
				+ ", acid=" + acid + ", report_name_1=" + report_name_1 + ", report_label_1=" + report_label_1
				...
				+ ", report_date=" + report_date + ", version=" + version + ", remarks=" + remarks + ", cust_type="
				+ cust_type + ", constitution_code=" + constitution_code + ", legal_entity_type=" + legal_entity_type
				+ ", constitution_desc=" + constitution_desc + ", segment=" + segment + ", sub_segment=" + sub_segment
				+ ", sector=" + sector + ", sub_sector=" + sub_sector + ", group_id=" + group_id + ", purpose_of_advn="
				+ purpose_of_advn + ", gl_sub_head_desc=" + gl_sub_head_desc + ", sector_code=" + sector_code
				+ ", hni_networth=" + hni_networth + ", turnover=" + turnover + ", bacid=" + bacid + ", maturity_date="
				+ maturity_date + ", country_of_incorp=" + country_of_incorp + ", country=" + country + ", gender="
				+ gender + ", nre_flg=" + nre_flg + ", getCust_id()=" + getCust_id() + ", getForacid()=" + getForacid()
				...
				+ getSol_id() + ", getAcid()=" + getAcid() + ", getReport_name_1()=" + getReport_name_1()
				+ ", getReport_label_1()=" + getReport_label_1() + ", getReport_addl_criteria_1()="
				+ getReport_addl_criteria_1() + ", getReport_addl_criteria_2()=" + getReport_addl_criteria_2()
				+ ", getReport_addl_criteria_3()=" + getReport_addl_criteria_3() + ", getCreate_user()="
				...
				+ ", getModify_flg()=" + getModify_flg() + ", getDel_flg()=" + getDel_flg() + ", getNre_status()="
				+ getNre_status() + ", getReport_date()=" + getReport_date() + ", getVersion()=" + getVersion()
				+ ", getRemarks()=" + getRemarks() + ", getCust_type()=" + getCust_type() + ", getConstitution_code()="
				+ getConstitution_code() + ", getLegal_entity_type()=" + getLegal_entity_type()
				+ ", getConstitution_desc()=" + getConstitution_desc() + ", getSegment()=" + getSegment()
				+ ", getSub_segment()=" + getSub_segment() + ", getSector()=" + getSector() + ", getSub_sector()="
				+ getSub_sector() + ", getGroup_id()=" + getGroup_id() + ", getPurpose_of_advn()="
				+ getPurpose_of_advn() + ", getGl_sub_head_desc()=" + getGl_sub_head_desc() + ", getSector_code()="
				+ getSector_code() + ", getHni_networth()=" + getHni_networth() + ", getTurnover()=" + getTurnover()
				+ ", getBacid()=" + getBacid() + ", getMaturity_date()=" + getMaturity_date()
				+ ", getCountry_of_incorp()=" + getCountry_of_incorp() + ", getCountry()=" + getCountry()
				+ ", getGender()=" + getGender() + ", getNre_flg()=" + getNre_flg() + ", getClass()=" + getClass()
				+ ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}
	public BRF109_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String gl_code2, String gl_sub_head_code2, String schm_code2, String schm_type2, String sol_id2,
			String acid2, String report_name_12, String report_label_12, String report_addl_criteria_12,
			...
			Character modify_flg2, Character del_flg2, Character nre_status2, Date report_date2, String version2,
			String remarks2, String cust_type2, String constitution_code2, String legal_entity_type2,
			String constitution_desc2, String segment2, String sub_segment2, String sector2, String sub_sector2,
			String group_id2, String purpose_of_advn2, String gl_sub_head_desc2, String sector_code2,
			BigDecimal hni_networth2, String turnover2, String bacid2, Date maturity_date2, String country_of_incorp2,
			String country2, String gender2, Character nre_flg2) {
