...
@Entity
@Table(name = "BRF37_MAPPING_TABLE")
public class BRF37_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public String toString() {
		return "BRF37_MAPPING_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", acct_name=" + acct_name
				...
				+ gender + ", nre_flg=" + nre_flg + ", act_balance_amt_lc=" + act_balance_amt_lc + ", int_rate="
				+ int_rate + ", getCust_id()=" + getCust_id() + ", getForacid()=" + getForacid() + ", getAcct_name()="
				+ getAcct_name() + ", getAcct_crncy_code()=" + getAcct_crncy_code() + ", getGl_code()=" + getGl_code()
				+ ", getGl_sub_head_code()=" + getGl_sub_head_code() + ", getSchm_code()=" + getSchm_code()
				...
				+ ", getVersion()=" + getVersion() + ", getRemarks()=" + getRemarks() + ", getCust_type()="
				+ getCust_type() + ", getConstitution_code()=" + getConstitution_code() + ", getLegal_entity_type()="
				+ getLegal_entity_type() + ", getConstitution_desc()=" + getConstitution_desc() + ", getSegment()="
				+ getSegment() + ", getSub_segment()=" + getSub_segment() + ", getSector()=" + getSector()
				+ ", getSub_sector()=" + getSub_sector() + ", getGroup_id()=" + getGroup_id()
				+ ", getPurpose_of_advn()=" + getPurpose_of_advn() + ", getGl_sub_head_desc()=" + getGl_sub_head_desc()
				+ ", getSector_code()=" + getSector_code() + ", getHni_networth()=" + getHni_networth()
				+ ", getTurnover()=" + getTurnover() + ", getBacid()=" + getBacid() + ", getMaturity_date()="
				+ getMaturity_date() + ", getCountry_of_incorp()=" + getCountry_of_incorp() + ", getCountry()="
				+ getCountry() + ", getGender()=" + getGender() + ", getNre_flg()=" + getNre_flg()
				+ ", getAct_balance_amt_lc()=" + getAct_balance_amt_lc() + ", getInt_rate()=" + getInt_rate()
				+ ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString()
				+ "]";
	}
	public BRF37_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String country2, String gender2, Character nre_flg2, BigDecimal act_balance_amt_lc, BigDecimal int_rate) {
