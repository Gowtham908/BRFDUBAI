...
@Entity
@Table(name="BRF57_DETAILTABLE")
public class BRF57_DETAIL_ENTITY {
	...
	public BRF57_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
