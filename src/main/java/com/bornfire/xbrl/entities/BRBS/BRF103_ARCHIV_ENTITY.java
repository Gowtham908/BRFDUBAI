...
@Entity
@Table(name="BRF103_ARCHIVETABLE")

public class BRF103_ARCHIV_ENTITY {
	...
	public BRF103_ARCHIV_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
			...
			String verify_user, String version) {
		super();
		this.acct_crncy_code = acct_crncy_code;
		this.acct_name = acct_name;
		this.acid = acid;
