...
@Entity
@Table(name="BRF81_DETAILTABLE")
public class BRF81_DETAIL_ENTITY {
	...
	public String toString() {
		return "BRF81_DETAIL_ENTITY [cust_id=" + cust_id + ", foracid=" + foracid + ", act_balance_amt_lc="
				...
				+ getCust_id() + ", getForacid()=" + getForacid() + ", getAct_balance_amt_lc()="
				+ getAct_balance_amt_lc() + ", getEab_lc()=" + getEab_lc() + ", getAcct_name()=" + getAcct_name()
	...
	public BRF81_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
			...
			String nre_status, Date report_date, Date maturity_date, String gender, String version, String remarks,
			Character nre_flg) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
