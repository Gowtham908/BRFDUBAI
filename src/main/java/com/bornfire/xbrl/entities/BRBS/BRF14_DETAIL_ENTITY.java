...
@Entity
@Table(name="BRF14_DETAILTABLE")
public class BRF14_DETAIL_ENTITY {
	...
	public BRF14_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
