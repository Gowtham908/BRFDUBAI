...
@Entity
@Table(name="BRF208_DETAILTABLE")

public class BRF208_DETAIL_ENTITY{
	...
	public BRF208_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
