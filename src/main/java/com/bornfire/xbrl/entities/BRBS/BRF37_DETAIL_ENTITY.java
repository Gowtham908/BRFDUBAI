...
@Entity
@Table(name="BRF37_DETAILTABLE")

public class BRF37_DETAIL_ENTITY 
{
	...
	public BRF37_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
