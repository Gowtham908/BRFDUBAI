...
@Entity
@Table(name="BRF3_ARCHIVTABLE")
public class BRF3_ARCH_DETAIL_ENTITY {
	...
	public BRF3_ARCH_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
	...
	public BRF3_ARCH_DETAIL_ENTITY() {
		super();
