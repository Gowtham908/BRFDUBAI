...
@Entity
@Table(name ="BRF10_ARCHIVTABLE")
public class BRF10_ARCHIVENTITY {
	...
	public BRF10_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
