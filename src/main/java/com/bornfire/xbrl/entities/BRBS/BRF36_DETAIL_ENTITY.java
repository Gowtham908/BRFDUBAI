...
@Entity
@Table(name="BRF36_DETAILTABLE")
public class BRF36_DETAIL_ENTITY {
	...
	public BRF36_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
