...
@Entity
@Table(name = "BRF41_MAPPING_TABLE")
public class BRF41_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF41_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String remarks2, String gender2, BigDecimal act_balance_amt_lc, String nationality, String state) {
