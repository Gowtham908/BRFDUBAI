...
@Entity
@Table(name ="BRF56_ARCHIVTABLE")
public class BRF56_ARCHIV_ENTITY {
	...
	public BRF56_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
