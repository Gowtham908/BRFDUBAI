...
@Entity
@Table(name = "BRF8_MAPPING_TABLE")
public class BRF8_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF8_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
