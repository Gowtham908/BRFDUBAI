...
@Entity
@Table(name="BRF202_ARCHIVETABLE")

public class BRF202_ARCHIV_ENTITY {
	...
	public BRF202_ARCHIV_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
