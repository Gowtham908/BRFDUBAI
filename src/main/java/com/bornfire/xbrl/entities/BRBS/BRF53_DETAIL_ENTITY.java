...
@Entity
@Table(name="BRF53_DETAILTABLE")

public class BRF53_DETAIL_ENTITY {
	...
	public BRF53_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
