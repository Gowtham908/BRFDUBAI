...
@Entity
@Table(name="BRF104A_DETAILTABLE")

public class BRF104_DETAIL_ENTITY{
	...
	public BRF104_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
