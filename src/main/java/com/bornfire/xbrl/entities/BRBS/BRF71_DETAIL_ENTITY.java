...
@Entity
@Table(name="BRF71_DETAILTABLE")
public class BRF71_DETAIL_ENTITY {
	...
	public BRF71_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
