...
@Entity
@Table(name = "BRF62_MAPPING_TABLE")
public class BRF62_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF62_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
			...
			String remarks2, String gender2, String nationality) {
