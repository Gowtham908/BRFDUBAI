...
@Entity
@Table(name="BRF300_DETAILTABLE")
public class BRF300_DETAIL_ENTITY {
	...
	public BRF300_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
