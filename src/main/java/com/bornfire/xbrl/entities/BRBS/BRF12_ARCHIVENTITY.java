...
@Entity
@Table(name="BRF12_ARCHIVTABLE")
public class BRF12_ARCHIVENTITY {
	...
	public BRF12_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
