...
@Entity
@Table(name="BRF84_DETAILTABLE")
public class BRF84_DETAIL_ENTITY {
	...
	public BRF84_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
