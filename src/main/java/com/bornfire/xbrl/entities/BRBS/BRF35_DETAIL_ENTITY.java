...
@Entity
@Table(name="BRF35_DETAILTABLE")

public class BRF35_DETAIL_ENTITY 
{
	...
	public BRF35_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
