...
@Entity
@Table(name="BRF57_ARCHIVTABLE")
public class BRF57_ARCHIVENTITY {
	...
	public BRF57_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
