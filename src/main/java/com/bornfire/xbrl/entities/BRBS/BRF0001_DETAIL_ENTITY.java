...
@Entity
@Table(name="BRF001_DETAILTABLE")
public class BRF0001_DETAIL_ENTITY {
	...
	public BRF0001_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
