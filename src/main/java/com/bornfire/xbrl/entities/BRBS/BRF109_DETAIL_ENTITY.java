...
@Entity
@Table(name="BRF109_DETAILTABLE")
public class BRF109_DETAIL_ENTITY {
	...
	public BRF109_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
