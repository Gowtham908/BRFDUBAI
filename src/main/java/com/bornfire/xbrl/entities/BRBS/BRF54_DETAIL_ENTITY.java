...
@Entity
@Table(name="BRF54_DETAILTABLE")

public class BRF54_DETAIL_ENTITY {
	...
	public BRF54_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
