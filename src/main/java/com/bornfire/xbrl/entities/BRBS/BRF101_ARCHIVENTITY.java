...
@Entity
@Table(name="BRF101_ARCHIVTABLE")
public class BRF101_ARCHIVENTITY {
	...
	public BRF101_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
