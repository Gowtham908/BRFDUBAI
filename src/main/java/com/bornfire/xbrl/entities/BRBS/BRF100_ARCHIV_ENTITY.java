...
@Entity
@Table(name="BRF100_ARCHIVETABLE")

public class BRF100_ARCHIV_ENTITY {
	...
	public BRF100_ARCHIV_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
