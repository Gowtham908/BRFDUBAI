...
@Entity
@Table(name="BRF95_DETAILTABLE")

public class BRF95_DETAIL_ENTITY{
	...
	public BRF95_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
