...
@Entity
@Table(name="BRF51_DETAILTABLE")
public class BRF51_DETAIL_ENTITY {
	...
	public BRF51_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
