...
@Entity
@Table(name="BRF82_DETAILTABLE")
public class BRF82_DETAIL_ENTITY {
	...
	public BRF82_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, String bacid,
