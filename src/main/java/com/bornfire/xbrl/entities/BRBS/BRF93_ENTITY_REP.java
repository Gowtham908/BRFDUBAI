...
public interface BRF93_ENTITY_REP  extends JpaRepository<BRF93_SUMMARYENTITY6, String>{
	
	@Query(value="select * from BRF93F_SUMMARYTABLE where report_date =?1",nativeQuery=true)
	...
	@Query(value="select COUNTRY_BREAK_DOWN,(CASE\r\n" + 
			...
			"from BRF93F_SUMMARYTABLE where report_date=?1",nativeQuery=true)
	List<Object[]> findallvalues(String to_date);
	
	
	///Remaining Countries
			//GOVT
			@Query(value="Select nvl(sum(govt_finan_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovtfintranremain(String value);
			
			@Query(value="Select nvl(sum(govt_finan_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovtfinamountremain(String value);
			
			@Query(value="Select nvl(sum(govt_direct_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovtdirtranremain(String value);
			
			@Query(value="Select nvl(sum(govt_direct_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovtdiramountremain(String value);
			
			@Query(value="Select nvl(sum(govt_service_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovtsertranremain(String value);
			
			@Query(value="Select nvl(sum(govt_service_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovtseramountremain(String value);
			
			@Query(value="Select nvl(sum(govt_trade_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovttradetranremain(String value);
			
			@Query(value="Select nvl(sum(govt_trade_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
			String getgovttradeamountremain(String value);
			
			
			  //RESERVE
			  
			@Query(value = "Select nvl(sum(reserve_finan_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getresfintranremain(String value);
			  
			@Query(value = "Select nvl(sum(reserve_finan_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getresfinamountremain(String value);

			@Query(value = "Select nvl(sum(reserve_direct_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getresdirtranremain(String value);

			@Query(value = "Select nvl(sum(reserve_direct_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getresdiramountremain(String value);

			@Query(value = "Select nvl(sum(reserve_service_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getressertranremain(String value);

			@Query(value = "Select nvl(sum(reserve_service_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getresseramountremain(String value);

			@Query(value = "Select nvl(sum(reserve_trade_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getrestradetranremain(String value);

			@Query(value = "Select nvl(sum(reserve_trade_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getrestradeamountremain(String value);

			// GRE

			@Query(value = "Select nvl(sum(gre_finan_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgrefintranremain(String value);

			@Query(value = "Select nvl(sum(gre_finan_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgrefinamountremain(String value);

			@Query(value = "Select nvl(sum(gre_direct_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgredirtranremain(String value);

			@Query(value = "Select nvl(sum(gre_direct_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgrediramountremain(String value);

			@Query(value = "Select nvl(sum(gre_service_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgresertranremain(String value);

			@Query(value = "Select nvl(sum(gre_service_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgreseramountremain(String value);

			@Query(value = "Select nvl(sum(gre_trade_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgretradetranremain(String value);

			@Query(value = "Select nvl(sum(gre_trade_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getgretradeamountremain(String value);
			//corporate
			
			@Query(value = "Select nvl(sum(corporate_finan_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcorfintranremain(String value);

			@Query(value = "Select nvl(sum(corporate_finan_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcorfinamountremain(String value);

			@Query(value = "Select nvl(sum(corporate_direct_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcorpdirtranremain(String value);

			@Query(value = "Select nvl(sum(corporate_direct_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcorpdiramountremain(String value);

			@Query(value = "Select nvl(sum(corporate_service_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcorsertranremain(String value);

			@Query(value = "Select nvl(sum(corporate_service_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcorseramountremain(String value);

			@Query(value = "Select nvl(sum(corporate_trade_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcortradetranremain(String value);

			@Query(value = "Select nvl(sum(corporate_trade_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getcortradeamountremain(String value);
			
			//SME
			
			@Query(value = "Select nvl(sum(sme_finan_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmefintranremain(String value);

			@Query(value = "Select nvl(sum(sme_finan_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmefinamountremain(String value);

			@Query(value = "Select nvl(sum(sme_direct_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmedirtranremain(String value);

			@Query(value = "Select nvl(sum(sme_direct_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmediramountremain(String value);

			@Query(value = "Select nvl(sum(sme_service_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmesertranremain(String value);

			@Query(value = "Select nvl(sum(sme_service_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmeseramountremain(String value);

			@Query(value = "Select nvl(sum(sme_trade_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmetradetranremain(String value);

			@Query(value = "Select nvl(sum(sme_trade_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getsmetradeamountremain(String value);
			
			//INDIVIDUAL
			
			@Query(value = "Select nvl(sum(indvidual_finan_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindfintranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_finan_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindfinamountremain(String value);

			@Query(value = "Select nvl(sum(indvidual_direct_invest_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getinddirtranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_direct_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getinddiramountremain(String value);

			@Query(value = "Select nvl(sum(indvidual_family_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindfamtranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_family_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindfamamountremain(String value);

			@Query(value = "Select nvl(sum(indvidual_educate_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindedutranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_educate_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindeduamountremain(String value);
			
			@Query(value = "Select nvl(sum(indvidual_medical_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindmedtranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_medical_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindmedamountremain(String value);

			@Query(value = "Select nvl(sum(indvidual_tour_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindtourtranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_tour_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindtourramountremain(String value);

			@Query(value = "Select nvl(sum(indvidual_debt_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getinddebttranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_debt_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getinddebtamountremain(String value);

			@Query(value = "Select nvl(sum(indvidual_other_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindothertranremain(String value);

			@Query(value = "Select nvl(sum(indvidual_other_invest_amount),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'", nativeQuery = true)
			String getindotheramountremain(String value);
			//ALL FEILDS(TRANSACTIONS) +COUNTRY
			
			
			////TOTAL.NO.OF.TRANSACTIONS
			@Query(value="SELECT nvl(sum(govt_finan_invest_no_of_transactions),0)+nvl(sum(govt_direct_invest_no_of_transactions),0)+nvl(sum(govt_service_no_of_transactions),0)+nvl(sum(govt_trade_no_of_transactions),0)+nvl(sum(reserve_finan_invest_no_of_transactions),0)+nvl(sum(reserve_direct_invest_no_of_transactions),0)+nvl(sum(reserve_service_no_of_transactions),0)+nvl(sum(reserve_trade_no_of_transactions),0)+nvl(sum(gre_finan_invest_no_of_transactions),0)+nvl(sum(gre_direct_invest_no_of_transactions),0)+nvl(sum(gre_service_no_of_transactions),0)+nvl(sum(gre_trade_no_of_transactions),0)+ nvl(sum(corporate_finan_invest_no_of_transactions),0)+nvl(sum(corporate_direct_invest_no_of_transactions),0)+nvl(sum(corporate_service_no_of_transactions),0)+nvl(sum(corporate_trade_no_of_transactions),0)+nvl(sum(sme_finan_invest_no_of_transactions),0)+nvl(sum(sme_direct_invest_no_of_transactions),0)+nvl(sum(sme_service_no_of_transactions),0)+nvl(sum(sme_trade_no_of_transactions),0)+nvl(sum(indvidual_finan_invest_no_of_transactions),0)+nvl(sum(indvidual_direct_invest_no_of_transactions),0)+nvl(sum(indvidual_family_no_of_transactions),0)+nvl(sum(indvidual_educate_no_of_transactions),0)+nvl(sum(indvidual_medical_no_of_transactions),0)+nvl(sum(indvidual_tour_no_of_transactions),0)+nvl(sum(indvidual_debt_no_of_transactions),0)+nvl(sum(indvidual_other_no_of_transactions),0) from BRF93F_SUMMARYTABLE where country_break_down='Remaining Countries'",nativeQuery=true)
