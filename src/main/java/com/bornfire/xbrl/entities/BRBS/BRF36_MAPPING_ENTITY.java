...
@Entity
@Table(name = "BRF36_MAPPING_TABLE")
public class BRF36_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF36_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code,
