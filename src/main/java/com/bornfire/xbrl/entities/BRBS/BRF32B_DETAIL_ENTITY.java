...
@Entity
@Table(name="BRF32B_DETAILTABLE")

public class BRF32B_DETAIL_ENTITY {
	...
	private BigDecimal	allocated_provision;
	private String	legal_case;
	...
	public BigDecimal getAllocated_provision() {
		return allocated_provision;
	}
	...
	public void setAllocated_provision(BigDecimal allocated_provision) {
		this.allocated_provision = allocated_provision;
	}
	public void setLegal_case(String legal_case) {
		this.legal_case = legal_case;
	}
	public BRF32B_DETAIL_ENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
			String bacid, String constitution_code, String constitution_desc, String country, String country_of_incorp,
			Date create_time, String create_user, String cust_id, String cust_type, String del_flg, BigDecimal eab_lc,
			String entity_flg, String foracid, String gender, String gl_code, String gl_sub_head_code,
			String gl_sub_head_desc, String group_id, BigDecimal hni_networth, String legal_entity_type,
			Date maturity_date, String modify_flg, Date modify_time, String modify_user, String nre_flg,
			String nre_status, String purpose_of_advn, String remarks, String report_addl_criteria_1,
			String report_addl_criteria_2, String report_addl_criteria_3, Date report_date, String report_label_1,
			String report_name_1, String schm_code, String schm_type, BigDecimal sector, String sector_code,
			String segment, String sol_id, String sub_sector, String sub_segment, String turnover, Date verify_time,
			String verify_user, String version, String group_name, BigDecimal specific_provision,
			BigDecimal allocated_provision, String legal_case) {
		super();
		this.acct_crncy_code = acct_crncy_code;
		this.acct_name = acct_name;
		this.acid = acid;
