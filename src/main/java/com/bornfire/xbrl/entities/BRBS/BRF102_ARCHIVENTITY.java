...
@Entity
@Table(name="BRF102_ARCHIVTABLE")
public class BRF102_ARCHIVENTITY {
	...
	public BRF102_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
