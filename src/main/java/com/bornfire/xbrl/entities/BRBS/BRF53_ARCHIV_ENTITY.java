...
@Entity
@Table(name="BRF53_ARCHIVETABLE")

public class BRF53_ARCHIV_ENTITY {
	...
	public BRF53_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
