...
@Entity
@Table(name = "BRF60_ARCHIVTABLE")
public class BRF60_ARCHIVENTITY {
	...
	public BRF60_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
