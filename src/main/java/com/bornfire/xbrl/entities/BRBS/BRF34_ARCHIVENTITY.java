...
@Entity
@Table(name = "BRF34_ARCHIVTABLE")
public class BRF34_ARCHIVENTITY {
	...
	public BRF34_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
