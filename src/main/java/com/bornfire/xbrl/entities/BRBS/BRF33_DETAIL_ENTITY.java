...
@Entity
@Table(name="BRF33_DETAILTABLE")
public class BRF33_DETAIL_ENTITY {
	...
	public BRF33_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
