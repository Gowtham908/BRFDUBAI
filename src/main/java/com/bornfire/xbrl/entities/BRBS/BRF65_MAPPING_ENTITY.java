...
@Entity
@Table(name = "BRF65_MAPPING_TABLE")
public class BRF65_MAPPING_ENTITY extends BRF_MAPPING_PARENT{
	...
	public BRF65_MAPPING_ENTITY(String cust_id, String foracid, String acct_name, String acct_crncy_code, String gl_code,
