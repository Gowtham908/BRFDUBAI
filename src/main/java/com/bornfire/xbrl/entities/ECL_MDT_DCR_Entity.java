...
@Entity
@Table(name="ECL_MASTER_DATA_DCR")
public class ECL_MDT_DCR_Entity {
	...
	public ECL_MDT_DCR_Entity(String sol_id, String cust_id, String map_key, String cust_name, String nature_asset_desc,
