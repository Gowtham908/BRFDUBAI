...
@Entity
@Table(name="BRF47B_ARCHIVTABLE")
public class BRF47B_ARCHIV_ENTITY {
	...
	public BRF47B_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
