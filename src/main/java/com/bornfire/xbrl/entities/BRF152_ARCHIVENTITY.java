...
@Entity
@Table(name="BRF152_ARCHIVTABLE")
public class BRF152_ARCHIVENTITY {
	...
	public BRF152_ARCHIVENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
