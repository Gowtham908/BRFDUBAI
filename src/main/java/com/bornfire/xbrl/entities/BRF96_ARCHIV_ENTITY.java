...
@Entity
@Table(name="BRF96_ARCHIVTABLE")
public class BRF96_ARCHIV_ENTITY {
	...
	public BRF96_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
