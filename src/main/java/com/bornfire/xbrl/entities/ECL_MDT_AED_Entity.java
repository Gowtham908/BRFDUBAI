...
@Entity
@Table(name="ECL_MASTER_DATA_AED")
public class ECL_MDT_AED_Entity {
	...
	public ECL_MDT_AED_Entity(String sol_id, String cust_id, String map_key, String cust_name, String nature_asset_desc,
