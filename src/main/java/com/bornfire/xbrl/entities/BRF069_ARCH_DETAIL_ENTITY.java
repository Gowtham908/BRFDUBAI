...
@Entity
@Table(name="BRF069_ARCH_DETAIL")
public class BRF069_ARCH_DETAIL_ENTITY {
	...
	public BRF069_ARCH_DETAIL_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
	...
	public BRF069_ARCH_DETAIL_ENTITY() {
		super();
