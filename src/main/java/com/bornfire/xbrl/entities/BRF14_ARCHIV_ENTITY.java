...
@Entity
@Table(name="BRF14_ARCHIVTABLE")
public class BRF14_ARCHIV_ENTITY {
	...
	public BRF14_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
