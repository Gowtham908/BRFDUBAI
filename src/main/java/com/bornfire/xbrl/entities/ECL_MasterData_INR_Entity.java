...
@Entity
@Table(name="ECL_MASTER_DATA_INR")
public class ECL_MasterData_INR_Entity {
	...
	public ECL_MasterData_INR_Entity(String sol_id, String cust_id, String map_key, String cust_name,
			String nature_asset_desc, String activity, Date disbursement_date, Date npa_date,
			BigDecimal limit_sanctioned, BigDecimal int_rate, BigDecimal coll_cash_security,
	...
	public ECL_MasterData_INR_Entity() {
		super();
