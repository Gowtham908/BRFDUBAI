...
@Entity
@Table(name="PERSONAL_INCOME_TABLE")
public class Personal_INCOME_Entity {
	...
	public Personal_INCOME_Entity() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Personal_INCOME_Entity(String variable, BigDecimal group_dbr, String bin_value, BigDecimal partial_score,
