...
@Entity
@Table(name="BRF38_ARCHIVTABLE")
public class BRF38_ARCHIVENTITY {
	...
	public BRF38_ARCHIVENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
