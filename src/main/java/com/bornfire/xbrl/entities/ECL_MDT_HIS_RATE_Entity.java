...
@Entity
@Table(name="ECL_MASTER_DATA_HIS_RATE")
public class ECL_MDT_HIS_RATE_Entity {
	...
	public ECL_MDT_HIS_RATE_Entity(String sol_id, String cust_id, String map_key, String cust_name,
	...
	public ECL_MDT_HIS_RATE_Entity() {
		super();
