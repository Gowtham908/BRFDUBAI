...
@Entity
@Table(name="ECL_MASTER_DATA_RECOVERY1")
public class ECL_MDT_RECOVERY_Entity {
	...
	public ECL_MDT_RECOVERY_Entity(String sol_id, String cust_id, String map_key, String cust_name,
	...
	public ECL_MDT_RECOVERY_Entity() {
		super();
