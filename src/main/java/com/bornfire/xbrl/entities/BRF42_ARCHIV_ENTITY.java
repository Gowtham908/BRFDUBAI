...
@Entity
@Table(name="BRF42_ARCHIVTABLE")
public class BRF42_ARCHIV_ENTITY {
	...
	public BRF42_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
