...
@Entity
@Table(name="BRF1_ARCHIVTABLE")
public class BRF1_ARCHIVENTITY {
	...
	public BRF1_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
