...
@Entity
@Table(name="BRF105_ARCHIVTABLE")
public class BRF105_ARCHIVENTITY {
	...
	public BRF105_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
