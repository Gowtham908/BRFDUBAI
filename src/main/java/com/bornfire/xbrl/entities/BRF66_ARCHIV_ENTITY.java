...
@Entity
@Table(name="BRF66_ARCHIVTABLE")
public class BRF66_ARCHIV_ENTITY {
	...
	public BRF66_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
