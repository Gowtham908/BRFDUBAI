...
@Entity
@Table(name="BRF107_ARCHIVTABLE")

public class BRF107_ARCHIV_ENTITY{
	...
	public BRF107_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
