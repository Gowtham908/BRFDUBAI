...
@Entity
@Table(name="BRF153_ARCHIVTABLE")

public class BRF153_ARCHIV_ENTITY {
	...
	public BRF153_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
			...
			String nre_status, Date report_date, String maturity_date, String version, String gender, String remarks) {
		super();
		this.cust_id = cust_id;
		this.foracid = foracid;
		this.acct_name = acct_name;
