...
@Entity
@Table(name="BRF210_ARCHIVTABLE")

public class BRF210_ARCHIVENTITY 
{
	...
	public BRF210_ARCHIVENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
