...
@Embeddable
public class BRF_FORWARD_REVEAL_MOD_Id implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BRF_FORWARD_REVEAL_MOD_Id other = (BRF_FORWARD_REVEAL_MOD_Id) obj;
	...
	public BRF_FORWARD_REVEAL_MOD_Id() {}
	
	public BRF_FORWARD_REVEAL_MOD_Id(BigDecimal instance_code, Date report_date) {
		super();
		this.instance_code = instance_code;
		this.report_date = report_date;
	}
