...
public class BRF_FORWARD_REVEALReport_Id implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BRF_FORWARD_REVEALReport_Id other = (BRF_FORWARD_REVEALReport_Id) obj;
   ...
   public BRF_FORWARD_REVEALReport_Id() {
		
		// TODO Auto-generated constructor stub
	}
public BRF_FORWARD_REVEALReport_Id(BigDecimal instance_code, Date report_date) {
	super();
	this.instance_code = instance_code;
	this.report_date = report_date;
}
...
public String toString() {
	return "SUP1500ReportId [instance_code=" + instance_code + ", report_date=" + report_date + "]";
}
