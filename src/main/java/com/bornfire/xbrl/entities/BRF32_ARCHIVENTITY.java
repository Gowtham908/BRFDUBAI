...
@Entity
@Table(name = "BRF32_ARCHIVTABLE")

public class BRF32_ARCHIVENTITY {
	...
	public BRF32_ARCHIVENTITY(String acct_crncy_code, String acct_name, String acid, BigDecimal act_balance_amt_lc,
