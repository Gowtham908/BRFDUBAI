...
@Entity
@Table(name="ECL_MASTER_DATA_SMOOTH")
public class ECL_MDT_SMOOTH_Entity {
	...
	public ECL_MDT_SMOOTH_Entity(String sol_id, String cust_id, String map_key, String cust_name,
