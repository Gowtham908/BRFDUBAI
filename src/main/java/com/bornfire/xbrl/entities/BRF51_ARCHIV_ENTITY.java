...
@Entity
@Table(name="BRF51_ARCHIVTABLE")
public class BRF51_ARCHIV_ENTITY {
	...
	public BRF51_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
