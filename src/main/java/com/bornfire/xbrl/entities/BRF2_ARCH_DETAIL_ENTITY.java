...
@Entity
@Table(name="BRF2_ARCH_DETAIL")
public class BRF2_ARCH_DETAIL_ENTITY {
	...
	public BRF2_ARCH_DETAIL_ENTITY(String sol_id, String acid, String foracid, String acct_name, String acct_no,
	...
	public BRF2_ARCH_DETAIL_ENTITY() {
		super();
