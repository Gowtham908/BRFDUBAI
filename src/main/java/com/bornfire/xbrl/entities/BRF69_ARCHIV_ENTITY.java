...
@Entity
@Table(name="BRF69_ARCHIVTABLE")

public class BRF69_ARCHIV_ENTITY{
	...
	public BRF69_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
