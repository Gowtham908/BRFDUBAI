...
@Entity
@Table(name="BRF209_ARCHIVTABLE")

public class BRF209_ARCHIV_ENTITY{
	...
	public BRF209_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
