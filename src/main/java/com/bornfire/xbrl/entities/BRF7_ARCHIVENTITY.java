...
@Entity
@Table(name="BRF7_ARCHIVTABLE")
public class BRF7_ARCHIVENTITY {
	...
	public BRF7_ARCHIVENTITY(String sol_id, String acid, String foracid, String acct_name, Character nre_flg,
