...
@Entity
@Table(name = "BRF88_ARCHIVTABLE")
public class BRF88_ARCHIV_ENTITY {
	...
	public BRF88_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
