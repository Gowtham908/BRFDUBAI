...
@Entity
@Table(name="SCORECARD_DBR")
public class Scorecard_DBR_Entity {
private String	variable;
	...
	public Scorecard_DBR_Entity(String variable, BigDecimal group_dbr, String bin_value, BigDecimal partial_score,
