...
@Entity
@Table(name="BRF49_ARCHIVTABLE")

public class BRF49_ARCHIV_ENTITY{
	...
	public BRF49_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
