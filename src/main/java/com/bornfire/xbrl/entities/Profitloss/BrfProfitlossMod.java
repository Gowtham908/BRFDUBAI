...
@Entity
@Table(name="BRF_PROFIT_TABLE_MOD_TABLE")
public class BrfProfitlossMod {
	
	@EmbeddedId
	private BRFPROFITLOSSMod_Id BRFPROFITLOSSMod_Id;
	...
	public BRFPROFITLOSSMod_Id getBRFPROFITLOSSMod_Id() {
		return BRFPROFITLOSSMod_Id;
	}
	public void setBRFPROFITLOSSMod_Id(BRFPROFITLOSSMod_Id bRFPROFITLOSSMod_Id) {
		BRFPROFITLOSSMod_Id = bRFPROFITLOSSMod_Id;
	}
	...
	public BrfProfitlossMod(com.bornfire.xbrl.entities.Profitloss.BRFPROFITLOSSMod_Id bRFPROFITLOSSMod_Id,
...
public BrfProfitlossMod() {
	...
	public BrfProfitlossMod(BrfprofitlossDetail detail) {
		super();
		this.BRFPROFITLOSSMod_Id = detail.getBRFPROFITLOSSMod_Id(detail.getBrfProfitlossDetailId());
		this.op_finance = op_finance;
		this.entite = entite;
		this.compte = compte;
		this.portefeuille = portefeuille;
