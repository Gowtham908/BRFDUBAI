...
@Entity
@Table(name = "BRF_PROFIT_LOSS_MANUAL_TABLE")
@IdClass(BRF_PROFIT_LOSS_ManualId.class)
public class BrfprofitlossMaual {
	...
	public BrfprofitlossMaual(String op_finance, String num_operation, String entite, String compte,
			String portefeuille, String mode_reglement, String flag_commission, String tiers, String flag_stade,
			String description1, Date date_operation, Date date_valeur, Date date_echeance, Date date_emission,
			String devise, String montant_signe, String montant_signe_origine, String devise_origine,
			String nombre_operations, String tri_1, String tri_2, String tri_3, String tri_devise, String contrevaleur,
			String contrevaleur_origine, String devise_cv, String reconciliation_flag, Date report_date, String del_flg,
	...
	public BrfprofitlossMaual(String op_finance, String num_operation, String entite, String compte,
			...
			String description1, Date date_operation, Date date_valeur, Date date_echeance, Date date_emission,
			String devise, String montant_signe, String montant_signe_origine, String devise_origine,
			String nombre_operations, String tri_1, String tri_2, String tri_3, String tri_devise,
			String contrevaleur, String contrevaleur_origine, String devise_cv, String reconciliation_flag,
			String report_date) {
		
	}
	public BrfprofitlossMaual(String op_finance, String num_operation, String entite, String compte,
			String portefeuille, String mode_reglement, String flag_commission, String tiers, String flag_stade,
			String description1, String date_operation, String date_valeur, String date_echeance,
			String date_emission, String devise, String montant_signe, String montant_signe_origine,
			String devise_origine, String nombre_operations, String tri_1, String tri_2, String tri_3,
			String tri_devise, String contrevaleur, String contrevaleur_origine, String devise_cv,
			String reconciliation_flag, String report_date) {
	...
	public void setDate_echeance(String string) {
		// TODO Auto-generated method stub
		
	}
	public void setDate_emission(String string) {
		// TODO Auto-generated method stub
