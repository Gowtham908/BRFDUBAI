...
import com.bornfire.xbrl.entities.BrfOutstandingEntries.BrfOustandingEntryMod_Id;
...
@Entity
@Table(name="BRF_PROFIT_LOSS_MAST_TABLE")
public class BrfprofitlossDetail {
	...
	public BrfprofitlossDetail(BrfProfitlossDetailId brfProfitlossDetailId,
	...
	public BrfprofitlossDetail(BrfprofitlossHistory hist) {

		this.BrfProfitlossDetailId = hist.getBrfProfitlossDetailId();
		this.op_finance = op_finance;
		this.entite = entite;
		this.compte = compte;
		this.portefeuille = portefeuille;
	...
	public BrfprofitlossDetail() {
		super();
	
	}
	public BrfprofitlossDetail(String op_finance, String entite, String compte, String portefeuille,
			String mode_reglement, String flag_commission, String tiers, String flag_stade, String description1,
			Date date_operation, Date date_valeur, Date date_echeance, Date date_emission, String devise,
			String montant_signe, String montant_signe_origine, String devise_origine, String nombre_operations,
			String tri_1, String tri_2, String tri_3, String tri_devise, String contrevaleur,
			String contrevaleur_origine, String devise_cv, String reconciliation_flag, Character del_flg,
			String rcre_user_id, Date rcre_time, String lchg_user_id, Date lchg_time, String verify_user_id,
			Date verify_time) {
		
	}
	
	public BrfprofitlossDetail(BrfProfitlossMod mod) {

		this.BrfProfitlossDetailId = new BrfProfitlossDetailId(mod.getBRFPROFITLOSSMod_Id());
		this.op_finance = op_finance;
		this.entite = entite;
		this.compte = compte;
		this.portefeuille = portefeuille;
	...
	public BRFPROFITLOSSMod_Id getBRFPROFITLOSSMod_Id(
			BrfProfitlossDetailId BrfProfitlossDetailId) {
