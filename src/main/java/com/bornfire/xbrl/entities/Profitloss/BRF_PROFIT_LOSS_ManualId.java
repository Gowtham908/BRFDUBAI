...
@Embeddable
public class BRF_PROFIT_LOSS_ManualId implements Serializable {
	...
	public BRF_PROFIT_LOSS_ManualId(String report_date, String num_operation) {
		super();
		this.report_date = report_date;
		this.num_operation = num_operation;
	}
	public BRF_PROFIT_LOSS_ManualId() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BRF_PROFIT_LOSS_ManualId other = (BRF_PROFIT_LOSS_ManualId) obj;
