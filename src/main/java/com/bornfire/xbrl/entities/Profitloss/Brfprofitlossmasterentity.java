...
@Entity
@Table(name = "BRF_PROFIT_LOSS_MASTER_TABLE")
public class Brfprofitlossmasterentity {
	...
	public Brfprofitlossmasterentity(String op_finance, String num_operation, String entite, String compte,
	...
	public Brfprofitlossmasterentity() {
		super();
