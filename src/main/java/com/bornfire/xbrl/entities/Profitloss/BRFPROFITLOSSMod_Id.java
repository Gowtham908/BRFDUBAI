...
@Embeddable
public class BRFPROFITLOSSMod_Id implements Serializable{
	...
	public BRFPROFITLOSSMod_Id(String num_operation, Date report_date) {
		super();
		this.num_operation = num_operation;
		this.report_date = report_date;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BRFPROFITLOSSMod_Id other = (BRFPROFITLOSSMod_Id) obj;
	...
	public BRFPROFITLOSSMod_Id(BrfProfitlossDetailId detail) {
		super();
