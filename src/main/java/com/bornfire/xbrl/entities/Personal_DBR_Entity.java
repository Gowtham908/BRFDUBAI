...
@Entity
@Table(name="PERSONAL_DBR_TABLE")
public class Personal_DBR_Entity {
	...
	public Personal_DBR_Entity() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Personal_DBR_Entity(String variable, BigDecimal group_dbr, String bin_value, BigDecimal partial_score,
