...
@Entity
@Table(name="BRF207_ARCHIVTABLE")

public class BRF207_ARCHIV_ENTITY{
	...
	public BRF207_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
