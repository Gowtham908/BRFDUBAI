...
@Entity
@Table(name="BRF70_ARCHIVTABLE")

public class BRF70_ARCHIV_ENTITY {
	...
	public BRF70_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
