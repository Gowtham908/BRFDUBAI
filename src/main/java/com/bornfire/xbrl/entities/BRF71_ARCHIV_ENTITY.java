...
@Entity
@Table(name="BRF71_ARCHIVTABLE")
public class BRF71_ARCHIV_ENTITY {
	...
	public BRF71_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
