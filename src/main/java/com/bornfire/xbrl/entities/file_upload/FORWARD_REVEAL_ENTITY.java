...
@Entity
@Table(name = "FORWARD_REVEAL_MANUAL_TABLE")
public class FORWARD_REVEAL_ENTITY {
	@Id
	...
	public String toString() {
		return "FORWARD_REVEAL_ENTITY [num_operation=" + num_operation + ", gl_values=" + gl_values + ", op_reference="
				+ op_reference + ", poste=" + poste + ", dealdate=" + dealdate + ", valuedate=" + valuedate
				+ ", maturitydate=" + maturitydate + ", currency1=" + currency1 + ", currency2=" + currency2
				...
				+ ", modify_flg=" + modify_flg + ", getNum_operation()=" + getNum_operation() + ", getGl_values()="
				+ getGl_values() + ", getOp_reference()=" + getOp_reference() + ", getPoste()=" + getPoste()
				+ ", getDealdate()=" + getDealdate() + ", getValuedate()=" + getValuedate() + ", getMaturitydate()="
				+ getMaturitydate() + ", getCurrency1()=" + getCurrency1() + ", getCurrency2()=" + getCurrency2()
				+ ", getNominal_1()=" + getNominal_1() + ", getRamount()=" + getRamount() + ", getNo_of_days()="
				+ getNo_of_days() + ", getAmount1()=" + getAmount1() + ", getDealrate()=" + getDealrate()
				+ ", getAmount2()=" + getAmount2() + ", getReval_rate()=" + getReval_rate() + ", getReval_amount()="
				+ getReval_amount() + ", getProfitloss()=" + getProfitloss() + ", getContrepartie()="
				+ getContrepartie() + ", getBranch_code()=" + getBranch_code() + ", getLcyrate()=" + getLcyrate()
				+ ", getLcyprofitloss()=" + getLcyprofitloss() + ", getReport_date()=" + getReport_date()
				+ ", getEntry_user()=" + getEntry_user() + ", getEntry_time()=" + getEntry_time()
				...
				+ getModify_flg() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
	public FORWARD_REVEAL_ENTITY(BigDecimal num_operation, BigDecimal gl_values, String op_reference, String poste,
			Date dealdate, Date valuedate, Date maturitydate, String currency1, String currency2, String nominal_1,
			String ramount, String no_of_days, String amount1, String dealrate, String amount2, String reval_rate,
			String reval_amount, String profitloss, String contrepartie, String branch_code, String lcyrate,
			String lcyprofitloss, Date report_date, String entry_user, Date entry_time, String modify_user,
			Date modify_time, String verify_user, Date verify_time, String del_flg, String entity_flg,
			String modify_flg) {
		super();
		this.num_operation = num_operation;
		this.gl_values = gl_values;
