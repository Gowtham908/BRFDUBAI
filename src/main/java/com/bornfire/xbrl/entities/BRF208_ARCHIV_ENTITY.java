...
@Entity
@Table(name="BRF208_ARCHIVTABLE")

public class BRF208_ARCHIV_ENTITY{
	...
	public BRF208_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
