...
@Entity
@Table(name ="BRF37_ARCHIVTABLE")

public class BRF37_ARCHIV_ENTITY {
	...
	public String getReport_lable_1() {
		return report_lable_1;
	}
	public void setReport_lable_1(String report_lable_1) {
		this.report_lable_1 = report_lable_1;
	}
	...
	public BRF37_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal accr_balance_lc,
