...
@Entity
@Table(name="ECL_MASTER_DATA_LRW")
public class ECL_MDT_LRW_Entity {
	...
	public ECL_MDT_LRW_Entity(String sol_id, String cust_id, String map_key, String cust_name, String nature_asset_desc,
			String activity, Date disbursement_date, Date npa_date, BigDecimal limit_sanctioned, BigDecimal int_rate,
			BigDecimal coll_cash_security, BigDecimal coll_non_crm_security, BigDecimal pri_cash_security,
			BigDecimal pri_non_crm_security, BigDecimal osbal_npa_date, BigDecimal write_off_amount,
			Date write_off_date, BigDecimal dec_2013, BigDecimal mar_2014, BigDecimal jun_2014, BigDecimal sep_2014,
			BigDecimal dec_2014, BigDecimal mar_2015, BigDecimal jun_2015, BigDecimal sep_2015, BigDecimal dec_2015,
			BigDecimal mar_2016, BigDecimal jun_2016, BigDecimal sep_2016, BigDecimal dec_2016, BigDecimal mar_2017,
			BigDecimal jun_2017, BigDecimal sep_2017, BigDecimal dec_2017, BigDecimal mar_2018, BigDecimal jun_2018,
			BigDecimal sep_2018, BigDecimal dec_2018, BigDecimal mar_2019, BigDecimal jun_2019, BigDecimal sep_2019,
			BigDecimal dec_2019, BigDecimal mar_2020, BigDecimal jun_2020, BigDecimal sep_2020, BigDecimal dec_2020,
			BigDecimal mar_2021, BigDecimal jun_2021, BigDecimal sep_2021, BigDecimal dec_2021, BigDecimal mar_2022,
			BigDecimal jun_2022, BigDecimal sep_2022, BigDecimal dec_2022, String remarks_1, BigDecimal mar_2023,
			BigDecimal jun_2023, BigDecimal sep_2023, BigDecimal dec_2023, BigDecimal mar_2024, BigDecimal jun_2024,
			BigDecimal sep_2024, BigDecimal dec_2024, BigDecimal mar_2025, BigDecimal jun_2025, BigDecimal sep_2025,
			BigDecimal dec_2025, BigDecimal mar_2026, BigDecimal jun_2026, BigDecimal sep_2026, BigDecimal dec_2026,
			BigDecimal mar_2027, BigDecimal jun_2027, BigDecimal sep_2027, BigDecimal dec_2027, BigDecimal mar_2028,
			BigDecimal jun_2028, BigDecimal sep_2028, BigDecimal dec_2028, BigDecimal mar_2029, BigDecimal jun_2029,
			BigDecimal sep_2029, BigDecimal dec_2029, BigDecimal mar_2030, BigDecimal jun_2030, BigDecimal sep_2030,
			BigDecimal dec_2030, BigDecimal mar_2031, BigDecimal jun_2031, BigDecimal sep_2031, BigDecimal dec_2031,
			String status, Date status_date, String remarks_2, String remarks_3, String del_flg, String upload_flg,
			Date upload_date, String entity_flg, String entry_user, Date entry_time, String modify_user,
			Date modify_time, String verify_user, Date verify_time) {
		super();
		this.sol_id = sol_id;
		this.cust_id = cust_id;
		this.map_key = map_key;
