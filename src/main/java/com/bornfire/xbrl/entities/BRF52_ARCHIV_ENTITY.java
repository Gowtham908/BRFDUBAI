...
@Entity
@Table(name="BRF52_ARCHIVTABLE")
public class BRF52_ARCHIV_ENTITY {
	...
	public BRF52_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
