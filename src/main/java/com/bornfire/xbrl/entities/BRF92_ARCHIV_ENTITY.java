...
@Entity
@Table(name="BRF92_ARCHIVTABLE")
public class BRF92_ARCHIV_ENTITY {
	...
	public BRF92_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
