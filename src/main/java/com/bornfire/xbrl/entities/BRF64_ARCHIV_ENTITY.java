...
@Entity
@Table(name="BRF64_ARCHIVTABLE")

public class BRF64_ARCHIV_ENTITY{
	...
	public BRF64_ARCHIV_ENTITY(String cust_id, String foracid, String acct_name, BigDecimal eab_lc,
