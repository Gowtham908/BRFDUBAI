...
@Entity
@Table(name="BRF47A_ARCHIVTABLE")
public class BRF47A_ARCHIV_ENTITY {
	...
	public BRF47A_ARCHIV_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
